...
`,$="auto",ee=V(L.E.div)`
  ...
  ${e=>{switch(e.$useTheme){case"web95":return $="light",X.web95;case"retro":return $="light",X.retro;case"soft":return $="light",X.soft;case"midnight":return $="dark",X.midnight;case"minimal":return $="light",X.minimal;case"rounded":return $="light",X.rounded;case"nouns":return $="light",X.nouns;default:if("light"===e.$useMode)return $="light",X.light;if("dark"===e.$useMode)return $="dark",X.dark;return A.iv`
  ...
  ${e=>{switch($){case"light":return q;case"dark":return K;default:return A.iv`
          ${q}
          @media (prefers-color-scheme: dark) {
            ${K}
          }
...
`,Portal=e=>{e={selector:"__CONNECTKIT__",...e};let{selector:n,children:t}=e,o=(0,S.useRef)(null),[i,r]=(0,S.useState)(!1);return((0,S.useEffect)(()=>{let e="#"+n.replace(/^#/,"");if(o.current=document.querySelector(e),!o.current){let e=document.createElement("div");e.setAttribute("id",n),e.setAttribute("data-connectkit",`${oT}`),document.body.appendChild(e),o.current=e}r(!0)},[n]),o.current&&i)?(0,_.createPortal)(t,o.current):null};var en={mobileWidth:560};let et=V(L.E.div)`
  z-index: -1;
  pointer-events: auto;
  position: absolute;
  left: 50%;
...
`,eu=V(L.E.div)`
  ...
  @media only screen and (max-width: ${en.mobileWidth}px) {
    display: block;
  }
`,ex=V(L.E.h1)`
  margin: 0;
...
`;let eb=V(L.E.div)`
  ...
  opacity: 0;
  animation: ${e=>e.$active?eo:ea} 150ms ease-out
    both;
`,eC=A.F4`
...
Vui l\xf2ng thử lại.`,injectionScreen_notconnected_h1:`Đăng nhập v\xe0o {{ CONNECTORNAME }}`,injectionScreen_notconnected_p:`Để tiếp tục, vui l\xf2ng đăng nhập bằng tiện \xedch {{ CONNECTORNAME }}.`,profileScreen_heading:"Đ\xe3 kết nối",switchNetworkScreen_heading:"Đổi mạng",signInWithEthereumScreen_tooltip:"Bạn chưa đăng nhập v\xe0o ứng dụng.\n**Đăng nhập qua Ethereum** để tiếp tục.",signInWithEthereumScreen_signedOut_heading:"Đăng nhập qua Ethereum",signInWithEthereumScreen_signedOut_h1:"Ứng dụng n\xe0y muốn x\xe1c nhận bạn \n l\xe0 chủ sở hữu của v\xed.",signInWithEthereumScreen_signedOut_p:`Vui l\xf2ng k\xfd tin nhắn y\xeau cầu 
 ...
 x\xe1c nhận lại trong l\xe0n tiếp theo.`,signInWithEthereumScreen_signedIn_button:"Đăng xuất"},getLocale=e=>{switch(e){case"ee-EE":return eR;case"ar-AE":return eB;case"es-ES":return eH;case"fa-IR":return eZ;case"fr-FR":return eU;case"ja-JP":return eG;case"pt-BR":return eV;case"ru-RU":return eP;case"zh-CN":return eY;case"ca-AD":return eQ;case"tr-TR":return eX;case"vi-VN":return eJ;default:return eD}};function useLocales(e){var n,t;let o=useContext(),i=null!==(t=null===(n=o.options)||void 0===n?void 0:n.language)&&void 0!==t?t:"en-US",r=(0,S.useMemo)(()=>getLocale(i),[i]);if(!r)return console.error(`Missing translations for: ${i}`),`Missing translations for: ${i}`;let a={};return Object.keys(r).map(n=>{let t=r[n];return a[n]=localize(t,e)}),a}let localize=(e,n)=>{let t=e;return n&&Object.keys(n).forEach(e=>{t=t.replace(RegExp(`({{ ${e} }})`,"g"),n[e])}),replaceMarkdown(t)},replaceMarkdown=e=>{let n=e;return n=(n=n.split("\n")).map((e,t)=>(0,j.jsxs)(S.Fragment,{children:[wrapTags(e),t<n.length-1&&(0,j.jsx)("br",{})]},t))},wrapTags=e=>{let n=e.split(/(\*\*[^\*]*\*\*)/g);return n.map((e,n)=>/(\*\*.*\*\*)/g.test(e)?(0,j.jsx)("strong",{children:e.replace(/\*\*/g,"")},n):`${e}`).map(e=>"string"==typeof e?e.split(/(\[WALLETCONNECTLOGO\])/g).map(e=>"[WALLETCONNECTLOGO]"===e?(0,j.jsx)("span",{className:"ck-tt-logo",children:(0,j.jsx)(R.WalletConnect,{})},e):e):e)},eq={debug:10,info:20,warn:30,error:40,none:100},eK="undefined"!=typeof window&&window.document&&void 0!==window.document.createElement?S.useLayoutEffect:S.useEffect,useFitText=({logLevel:e="info",maxFontSize:n=100,minFontSize:t=20,onFinish:o,onStart:i,resolution:r=5}={})=>{let a=eq[e],s=(0,S.useCallback)(()=>({calcKey:0,fontSize:n,fontSizePrev:t,fontSizeMax:n,fontSizeMin:t}),[n,t]),c=(0,S.useRef)(null),l=(0,S.useRef)(),d=(0,S.useRef)(!1),[p,h]=(0,S.useState)(s),{calcKey:u,fontSize:x,fontSizeMax:g,fontSizeMin:b,fontSizePrev:C}=p,m=null,[f]=(0,S.useState)(()=>new T.Z(()=>{m=window.requestAnimationFrame(()=>{d.current||(i&&i(),d.current=!0,h({...s(),calcKey:u+1}))})}));(0,S.useEffect)(()=>(c.current&&f.observe(c.current),()=>{m&&window.cancelAnimationFrame(m),f.disconnect()}),[m,f]);let v=c.current&&c.current.innerHTML;return(0,S.useEffect)(()=>{0===u||d.current||(v!==l.current&&(i&&i(),h({...s(),calcKey:u+1})),l.current=v)},[u,s,v,i]),eK(()=>{let e;if(0===u)return;let n=Math.abs(x-C)<=r,i=!!c.current&&(c.current.scrollHeight>c.current.offsetHeight||c.current.scrollWidth>c.current.offsetWidth),s=i&&x===C,l=x>C;if(n){s?(d.current=!1,a<=eq.info&&console.info(`[use-fit-text] reached \`minFontSize = ${t}\` without fitting text`)):i?h({fontSize:l?C:b,fontSizeMax:g,fontSizeMin:b,fontSizePrev:C,calcKey:u}):(d.current=!1,o&&o(x));return}let p=g,m=b;i?(e=l?C-x:b-x,p=Math.min(g,x)):(e=l?g-x:C-x,m=Math.max(b,x)),h({calcKey:u,fontSize:x+e/2,fontSizeMax:p,fontSizeMin:m,fontSizePrev:x})},[u,x,g,b,C,o,c,r]),{fontSize:x,ref:c}},FitText=({children:e})=>{let[n,t]=S.useState(!1),{fontSize:o,ref:i}=useFitText({logLevel:"none",maxFontSize:100,minFontSize:70,onStart:()=>t(!0),onFinish:()=>t(!0)});return(0,j.jsx)("div",{ref:i,style:{visibility:n?"visible":"hidden",fontSize:`${o}%`,maxHeight:"100%",maxWidth:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:e})};function useConnectors(){let e=(0,s.Y)();return null!=e?e:[]}function useConnector(e,n){let t=useConnectors();return"injected"===e&&n?t.find(t=>t.id===e&&t.name===n):"injected"===e?t.find(n=>n.id===e&&n.name.includes("Injected")):t.find(n=>n.id===e)}FitText.displayName="FitText";let useWallet=e=>{let n=useWallets(),t=n.find(n=>n.id===e);return t||null},useWallets=()=>{let e=useConnectors(),n=useContext(),t=e.map(e=>{var n,t;let o=Object.keys(Z).find(n=>-1!==n.split(",").map(e=>e.trim()).indexOf(e.id)),i={id:e.id,name:null!==(t=null!==(n=e.name)&&void 0!==n?n:e.id)&&void 0!==t?t:e.type,icon:(0,j.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}),connector:e,iconShape:"squircle",isInstalled:"mock"===e.type||"injected"===e.type&&"metaMask"!==e.id||isCoinbaseWalletConnector(e.id)};if(o){let n=Z[o];return{...i,iconConnector:e.icon?(0,j.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}):void 0,...n}}return i});return t.filter((e,n,t)=>t.findIndex(n=>n.id===e.id)===n).map(e=>{var t,o;return"walletConnect"===e.id?{...e,name:(null===(t=n.options)||void 0===t?void 0:t.walletConnectName)||e.name,shortName:(null===(o=n.options)||void 0===o?void 0:o.walletConnectName)||e.shortName}:e}).filter((e,n,t)=>!("coinbaseWalletSDK"===e.id&&t.find(e=>"com.coinbase.wallet"===e.id))).filter((e,n,t)=>!(("metaMaskSDK"===e.id||"metaMask"===e.id)&&t.find(e=>"io.metamask"===e.id||"io.metamask.mobile"===e.id))).sort((e,n)=>{let t=e.isInstalled&&isInjectedConnector(e.connector.type),o=n.isInstalled&&isInjectedConnector(n.connector.type);return t&&!o?-1:!t&&o?1:0}).sort((e,n)=>"walletConnect"===e.id?1:"walletConnect"===n.id?-1:0)},ProfileIcon=({isSignedIn:e})=>(0,j.jsxs)("div",{style:{position:"relative"},children:[e?(0,j.jsx)(AuthIcon,{style:{bottom:-1,right:-1}}):(0,j.jsx)("div",{style:{zIndex:2,position:"absolute",top:-2,right:-2,background:"#1A88F8",borderRadius:8,boxShadow:"0 0 0 2px var(--ck-body-background)",width:8,height:8}}),(0,j.jsxs)("svg",{"aria-hidden":"true",width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{overflow:"visible"},children:[(0,j.jsx)("circle",{cx:"10",cy:"10",r:"9",stroke:"currentColor",strokeWidth:"2"}),(0,j.jsx)("path",{d:"M16.5 16.775C14.8618 15.0649 12.5552 14 10 14C7.44477 14 5.13825 15.0649 3.5 16.775",stroke:"currentColor",strokeWidth:"2"}),(0,j.jsx)("circle",{cx:"10",cy:"8",r:"3",stroke:"currentColor",strokeWidth:"2"})]})]}),InfoIcon=({...e})=>(0,j.jsx)("svg",{"aria-hidden":"true",width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,j.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M20 11C20 15.9706 15.9706 20 11 20C6.02944 20 2 15.9706 2 11C2 6.02944 6.02944 2 11 2C15.9706 2 20 6.02944 20 11ZM22 11C22 17.0751 17.0751 22 11 22C4.92487 22 0 17.0751 0 11C0 4.92487 4.92487 0 11 0C17.0751 0 22 4.92487 22 11ZM11.6445 12.7051C11.6445 13.1348 11.3223 13.4678 10.7744 13.4678C10.2266 13.4678 9.92578 13.1885 9.92578 12.6191V12.4795C9.92578 11.4268 10.4951 10.8574 11.2686 10.3203C12.2031 9.67578 12.665 9.32129 12.665 8.59082C12.665 7.76367 12.0205 7.21582 11.043 7.21582C10.3232 7.21582 9.80762 7.57031 9.45312 8.16113C9.38282 8.24242 9.32286 8.32101 9.2667 8.39461C9.04826 8.68087 8.88747 8.8916 8.40039 8.8916C8.0459 8.8916 7.66992 8.62305 7.66992 8.15039C7.66992 7.96777 7.70215 7.7959 7.75586 7.61328C8.05664 6.625 9.27051 5.75488 11.1182 5.75488C12.9336 5.75488 14.5234 6.71094 14.5234 8.50488C14.5234 9.7832 13.7822 10.417 12.7402 11.1045C11.999 11.5986 11.6445 11.9746 11.6445 12.5762V12.7051ZM11.9131 15.5625C11.9131 16.1855 11.376 16.6797 10.7529 16.6797C10.1299 16.6797 9.59277 16.1748 9.59277 15.5625C9.59277 14.9395 10.1191 14.4453 10.7529 14.4453C11.3867 14.4453 11.9131 14.9287 11.9131 15.5625Z",fill:"currentColor"})}),CloseIcon=({...e})=>(0,j.jsx)(L.E.svg,{width:14,height:14,viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,j.jsx)("path",{d:"M1 13L13 1M1 1L13 13",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"})}),BackIcon=({...e})=>(0,j.jsx)(L.E.svg,{width:9,height:16,viewBox:"0 0 9 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,j.jsx)("path",{d:"M8 1L1 8L8 15",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),e$={initial:{zIndex:2,opacity:0},animate:{opacity:1,scale:1,transition:{duration:.165,delay:.055,ease:[.26,.08,.25,1]}},exit:{zIndex:1,opacity:0,pointerEvents:"none",position:"absolute",left:["50%","50%"],x:["-50%","-50%"],transition:{duration:.22,ease:[.26,.08,.25,1]}}},Modal=({open:e,pages:n,pageId:t,positionInside:o,inline:i,demo:r,onClose:a,onBack:s,onInfo:d})=>{var p,h,u,x,g,b,C,m,f,v,k,w;let y;let E=useContext(),N=useThemeContext(),I=isMobile(),{isSignedIn:A,reset:_}=useSIWE(),F=useWallet(null===(p=E.connector)||void 0===p?void 0:p.id),O={name:null==F?void 0:F.name,shortName:null!==(h=null==F?void 0:F.shortName)&&void 0!==h?h:null==F?void 0:F.name,icon:null!==(u=null==F?void 0:F.iconConnector)&&void 0!==u?u:null==F?void 0:F.icon,iconShape:null!==(x=null==F?void 0:F.iconShape)&&void 0!==x?x:"circle",iconShouldShrink:null==F?void 0:F.iconShouldShrink},W=useLocales({CONNECTORNAME:null==O?void 0:O.name}),[T,z]=(0,D.Y)({timeout:160,preEnter:!0,mountOnEnter:!0,unmountOnExit:!0}),B=!("exited"===T||"unmounted"===T),R="preEnter"===T||"exiting"!==T,H=E.route===of.CONNECTORS?0:E.route===of.DOWNLOAD?2:1,Z=usePrevious(H,H);o||useLockBodyScroll(B),usePrevious(t,t),(0,S.useEffect)(()=>{z(e),e&&P(void 0)},[e]);let[U,G]=(0,S.useState)({width:void 0,height:void 0}),[V,P]=(0,S.useState)(void 0),updateBounds=e=>{let n={width:null==e?void 0:e.offsetWidth,height:null==e?void 0:e.offsetHeight};G({width:`${null==n?void 0:n.width}px`,height:`${null==n?void 0:n.height}px`})},Y=(0,S.useCallback)(e=>{e&&(J.current=e,P(void 0!==V),clearTimeout(y),y=setTimeout(()=>P(!1),360),updateBounds(e))},[e,V]),{chain:Q}=(0,c.m)(),{switchChain:X}=(0,l.o)(),J=(0,S.useRef)(null);(0,S.useEffect)(()=>{J.current&&updateBounds(J.current)},[Q,X,I,A,E.options,E.resize]),(0,S.useEffect)(()=>{if(!B){G({width:void 0,height:void 0});return}let listener=e=>{"Escape"===e.key&&a&&a()};return document.addEventListener("keydown",listener),()=>{document.removeEventListener("keydown",listener)}},[B,a]);let q={"--height":U.height,"--width":U.width},K=(0,j.jsx)(ee,{$useTheme:null!==(g=null==r?void 0:r.theme)&&void 0!==g?g:N.theme,$useMode:null!==(b=null==r?void 0:r.mode)&&void 0!==b?b:N.mode,$customTheme:null!==(C=null==r?void 0:r.customTheme)&&void 0!==C?C:N.customTheme,children:(0,j.jsxs)(eE,{role:"dialog",style:{pointerEvents:R?"auto":"none",position:o?"absolute":void 0},children:[!i&&(0,j.jsx)(eb,{$active:R,onClick:a,$blur:null===(m=E.options)||void 0===m?void 0:m.overlayBlur}),(0,j.jsxs)(eA,{style:q,initial:!1,children:[(0,j.jsx)("div",{style:{pointerEvents:V?"all":"none",position:"absolute",top:0,bottom:0,left:"50%",transform:"translateX(-50%)",width:"var(--width)",zIndex:9,transition:"width 200ms ease"}}),(0,j.jsxs)(ek,{className:`${R&&"active"}`,children:[(0,j.jsx)(M.M,{initial:!1,children:(null===(f=E.options)||void 0===f?void 0:f.disclaimer)&&E.route===of.CONNECTORS&&(0,j.jsx)(eF,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{delay:0,duration:.2,ease:[.25,.1,.25,1]},children:(0,j.jsx)(e_,{children:(0,j.jsx)("div",{children:null===(v=E.options)||void 0===v?void 0:v.disclaimer})})})}),(0,j.jsx)(M.M,{initial:!1,children:E.errorMessage&&(0,j.jsxs)(et,{initial:{y:"10%",x:"-50%"},animate:{y:"-100%"},exit:{y:"100%"},transition:{duration:.2,ease:"easeInOut"},children:[(0,j.jsx)("span",{children:E.errorMessage}),(0,j.jsx)("div",{onClick:()=>E.displayError(null),style:{position:"absolute",right:24,top:24,cursor:"pointer"},children:(0,j.jsx)(CloseIcon,{})})]})}),(0,j.jsxs)(ew,{children:[a&&(0,j.jsx)(eN,{"aria-label":flattenChildren(W.close).toString(),onClick:a,children:(0,j.jsx)(CloseIcon,{})}),(0,j.jsx)("div",{style:{position:"absolute",top:23,left:20,width:32,height:32},children:(0,j.jsx)(M.M,{children:s?(0,j.jsx)(eM,{disabled:V,"aria-label":flattenChildren(W.back).toString(),onClick:s,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:I?0:.1,delay:I?.01:0},children:(0,j.jsx)(BackIcon,{})},"backButton"):E.route===of.PROFILE&&E.signInWithEthereum?(0,j.jsxs)(j.Fragment,{children:[!A&&!(null===(k=E.options)||void 0===k?void 0:k.hideTooltips)&&(0,j.jsx)(L.E.div,{style:{position:"absolute",inset:0,pointerEvents:"none"},initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1,transition:{delay:.5,duration:.2}},exit:{opacity:0,scale:.6,transition:{delay:0,duration:I?0:.1}},children:(0,j.jsx)(eO,{children:W.signInWithEthereumScreen_tooltip})}),(0,j.jsx)(eL,{disabled:V,"aria-label":W.signInWithEthereumScreen_signedOut_heading,onClick:()=>{_(),E.setRoute(of.SIGNINWITHETHEREUM)},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:I?0:.1,delay:I?.01:0},children:(0,j.jsx)(ProfileIcon,{isSignedIn:A})},"siweButton")]}):d&&!(null===(w=E.options)||void 0===w?void 0:w.hideQuestionMarkCTA)&&(0,j.jsx)(eI,{disabled:V,"aria-label":flattenChildren(W.moreInformation).toString(),onClick:d,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:I?0:.1,delay:I?.01:0},children:(0,j.jsx)(InfoIcon,{})},"infoButton")})})]}),(0,j.jsx)(ep,{children:(0,j.jsx)(M.M,{children:(0,j.jsx)(L.E.div,{style:{position:"absolute",top:0,bottom:0,left:52,right:52,display:"flex",justifyContent:"center"},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:I?0:.17,delay:I?.01:0},children:(0,j.jsx)(FitText,{children:function(){var e;switch(E.route){case of.ABOUT:return W.aboutScreen_heading;case of.CONNECT:if(function(){if(!F)return!1;let e=!F.getWalletConnectDeeplink||F.isInstalled;return!e}())return isWalletConnectConnector(null===(e=null==F?void 0:F.connector)||void 0===e?void 0:e.id)?W.scanScreen_heading:W.scanScreen_heading_withConnector;return null==O?void 0:O.name;case of.CONNECTORS:return W.connectorsScreen_heading;case of.MOBILECONNECTORS:return W.mobileConnectorsScreen_heading;case of.DOWNLOAD:return W.downloadAppScreen_heading;case of.ONBOARDING:return W.onboardingScreen_heading;case of.PROFILE:return W.profileScreen_heading;case of.SWITCHNETWORKS:return W.switchNetworkScreen_heading;case of.SIGNINWITHETHEREUM:return A?W.signInWithEthereumScreen_signedIn_heading:W.signInWithEthereumScreen_signedOut_heading;default:return""}}()})},`${E.route}-${A?"signedIn":""}`)})}),(0,j.jsx)(ey,{children:Object.keys(n).map(e=>{let i=n[e];return(0,j.jsx)(Page,{open:e===t,initial:!o&&"entered"!==T,enterAnim:e===t?H>Z?"active-scale-up":"active":"",exitAnim:e!==t?H<Z?"exit-scale-down":"exit":"",children:(0,j.jsx)(eS,{ref:Y,style:{pointerEvents:e===t&&R?"auto":"none"},children:i},`inner-${e}`)},e)})})]})]})]})});return(0,j.jsx)(j.Fragment,{children:B&&(0,j.jsx)(j.Fragment,{children:o?K:(0,j.jsx)(j.Fragment,{children:(0,j.jsx)(Portal,{children:(0,j.jsx)(FocusTrap,{children:K})})})})})},Page=({children:e,open:n,initial:t,prevDepth:o,currentDepth:i,enterAnim:r,exitAnim:a})=>{let[s,c]=(0,D.Y)({timeout:400,preEnter:!0,initialEntered:n,mountOnEnter:!0,unmountOnExit:!0});return((0,S.useEffect)(()=>{c(n)},[n]),"exited"===s||"unmounted"===s)?null:(0,j.jsx)(ej,{className:`${"preEnter"===s||"exiting"!==s?r:a}`,style:{animationDuration:t?"0ms":void 0,animationDelay:t?"0ms":void 0},children:e})},OrDivider=({children:e})=>{let n=useLocales();return(0,j.jsx)(ed,{children:(0,j.jsx)("span",{children:null!=e?e:n.or})})},e1=V(L.E.div)`
  position: relative;
...
`,e3=V(L.E.div)`
  ...
  animation: ${e2} 1000ms 100ms ease both;
  @media only screen and (max-width: ${en.mobileWidth}px) {
    animation: none;
  }
`,e5=A.F4`
...
`,nt=V(L.E.div)`
  ...
  animation: ${e5} 750ms cubic-bezier(0.19, 1, 0.22, 1) both;
  ...
  &:nth-child(1){ ${e7}{ animation-delay:-200ms; } }
  &:nth-child(2){ ${e7}{ animation-delay:-600ms; } }
  &:nth-child(3){ ${e7}{ animation-delay:-800ms; } }
  &:nth-child(4){ ${e7}{ animation-delay:-300ms; } }
  &:nth-child(5){ ${e7}{ animation-delay:-3200ms; } }
...
`,np=V.button`
  ...
  @media only screen and (min-width: ${en.mobileWidth+1}px) {
    &:hover,
    &:focus-visible {
...
`,ng=V(L.E.div)`
  ...
  svg {
    display: block;
    position: relative;
    animation: ${nx} 1s ease-in-out infinite;
  }
`,nb={duration:.4,ease:[.175,.885,.32,.98]},Spinner$4=()=>(0,j.jsx)(ng,{initial:{opacity:0,rotate:180},animate:{opacity:1,rotate:0},exit:{position:"absolute",opacity:0,rotate:-180,transition:{...nb}},transition:{...nb,delay:.2},children:(0,j.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,j.jsx)("circle",{cx:"9",cy:"9",r:"7",stroke:"currentColor",strokeOpacity:"0.1",strokeWidth:"2.5"}),(0,j.jsx)("path",{d:"M16 9C16 5.13401 12.866 2 9 2",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round"})]})}),nC={duration:.4,ease:[.175,.885,.32,.98]},Button=({children:e,variant:n="secondary",disabled:t,icon:o,iconPosition:i="left",roundedIcon:r,waiting:a,arrow:s,download:c,href:l,style:d,onClick:p})=>{let h="string"==typeof e?e:flattenChildren(e).join(""),u="string"==typeof l?l:flattenChildren(l).join("");return(0,j.jsx)(np,{as:l?"a":void 0,onClick:e=>{!t&&p&&p(e)},href:u,target:l&&"_blank",rel:l&&"noopener noreferrer",disabled:t,$variant:n,style:d,children:(0,j.jsxs)(M.M,{initial:!1,children:[(0,j.jsxs)(nd,{initial:{opacity:0,y:-10},animate:{opacity:1,y:-1},exit:{position:"absolute",opacity:0,y:10,transition:{...nC}},transition:{...nC,delay:.2},children:[o&&"left"===i&&(0,j.jsx)(nu,{$rounded:r,children:o}),c&&(0,j.jsx)(nc,{children:(0,j.jsx)(nl,{children:(0,j.jsxs)(nr,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,j.jsx)(ns,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"}),(0,j.jsx)(na,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"})]})})}),(0,j.jsx)(nh,{style:{paddingLeft:s?6:0},children:(0,j.jsx)(FitText,{children:e})}),o&&"right"===i&&(0,j.jsx)(nu,{$rounded:r,children:o}),s&&(0,j.jsxs)(nr,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,j.jsx)(ns,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"2",strokeLinecap:"round"}),(0,j.jsx)(na,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"2",strokeLinecap:"round"})]})]},h),a&&(0,j.jsx)(ni,{children:(0,j.jsx)(Spinner$4,{})})]})})},Introduction=()=>{var e,n;let t=useContext(),o=useLocales({}),i=null!==(n=null===(e=t.options)||void 0===e?void 0:e.walletOnboardingUrl)&&void 0!==n?n:o.onboardingScreen_ctaUrl;return(0,j.jsxs)(el,{children:[(0,j.jsxs)(e1,{children:[(0,j.jsxs)(e0,{children:[(0,j.jsx)(nt,{children:(0,j.jsx)(e4,{children:(0,j.jsx)(e9,{children:(0,j.jsx)(e7,{children:(0,j.jsx)(nn,{children:(0,j.jsx)(e8,{children:(0,j.jsx)(R.Coinbase,{background:!0})})})})})})}),(0,j.jsx)(nt,{children:(0,j.jsx)(e4,{children:(0,j.jsx)(e9,{children:(0,j.jsx)(e7,{children:(0,j.jsx)(nn,{children:(0,j.jsx)(e8,{children:(0,j.jsx)(R.MetaMask,{background:!0})})})})})})}),(0,j.jsx)(nt,{children:(0,j.jsx)(e4,{children:(0,j.jsx)(e9,{children:(0,j.jsx)(e7,{children:(0,j.jsx)(nn,{children:(0,j.jsx)(e8,{children:(0,j.jsx)(R.Trust,{})})})})})})}),(0,j.jsx)(nt,{children:(0,j.jsx)(e4,{children:(0,j.jsx)(e9,{children:(0,j.jsx)(e7,{children:(0,j.jsx)(nn,{children:(0,j.jsx)(e8,{children:(0,j.jsx)(R.Argent,{})})})})})})}),(0,j.jsx)(nt,{children:(0,j.jsx)(e4,{children:(0,j.jsx)(e9,{children:(0,j.jsx)(e7,{children:(0,j.jsx)(nn,{children:(0,j.jsx)(e8,{children:(0,j.jsx)(R.ImToken,{})})})})})})})]}),(0,j.jsx)(e3,{children:no})]}),(0,j.jsxs)(eu,{style:{paddingBottom:18},children:[(0,j.jsx)(ex,{$small:!0,children:o.onboardingScreen_h1}),(0,j.jsx)(eg,{children:o.onboardingScreen_p})]}),(0,j.jsx)(Button,{href:i,arrow:!0,children:o.onboardingScreen_ctaText})]})},nm=V.div`
  pointer-events: none;
  user-select: none;
  height: ${208}px;
  padding: 0 0 12px;
...
`,nS=V.button`
  ...
  ${e=>e.$active?A.iv`
        ...
        `}
`,nE={scale:[.9,1.25,1.6],opacity:[0,.11,0]},nN={ease:"linear",duration:2,repeat:1/0},nL=V.div`
  position: absolute;
  left: 50%;
  top: 50%;
...
`,nI=V(L.E.div)`
  ...
  overflow: hidden;
  border-radius: 100%;
  animation: ${nM} 16s linear infinite;
`,nA=V(L.E.div)`
  overflow: hidden;
...
`,nX=V.div`
  ...
  ${e=>e.$mobile?A.iv`
          ...
          ${nG} {
            flex-shrink: 0;
            width: 80px;
            ${nY.mobile.ConnectorButton}
            ${nV} {
              ${nY.mobile.ConnectorLabel}
              ${nQ} {
                display: none;
                width: fit-content;
                margin: 0 auto;
        ...
        `:A.iv`
          ...
          ${nG} {
            ${nY.desktop.ConnectorButton}
            ${nV} {
              ${nY.desktop.ConnectorLabel}
            }
            ${nP} {
              ${nY.desktop.ConnectorIcon}
            }
          }
        `}
`;function useChains(){var e;let n=(0,d.Z)(),t=null!==(e=null==n?void 0:n.chains)&&void 0!==e?e:[];return t.map(e=>e)}function useConnect({...e}={}){let n=useContext(),{connect:t,connectAsync:o,connectors:i,...r}=(0,p.$)({...e,mutation:{...e.mutation,onError(e){e.message?"User rejected request"!==e.message&&n.log(e.message,e):n.log("Could not connect.",e)}}});return{connect:({connector:e,chainId:o,mutation:i})=>{var r;return t({connector:e,chainId:null!=o?o:null===(r=n.options)||void 0===r?void 0:r.initialChainId},i)},connectAsync:async({connector:e,chainId:t,mutation:i})=>{var r;return o({connector:e,chainId:null!=t?t:null===(r=n.options)||void 0===r?void 0:r.initialChainId},i)},connectors:i,...r}}function useChainIsSupported(e){let{chains:n}=(0,d.Z)();return!!e&&n.some(n=>n.id===e)}let nJ=S.createContext({connect:{getUri:()=>""},dapp:{chains:[]},account:void 0}),Web3ContextProvider=({enabled:e,children:n})=>{let{uri:t}=function({enabled:e}={enabled:!0}){let{log:n}=useContext(),[t,o]=(0,S.useState)(void 0),i=useConnector("walletConnect"),{isConnected:r}=(0,c.m)(),{connectAsync:a}=useConnect();return(0,S.useEffect)(()=>{if(e){if(r)o(void 0);else{if(!i||t)return;if(i&&!r)return connectWalletConnect(i),n("add wc listeners"),i.emitter.on("message",handleMessage),i.emitter.on("disconnect",handleDisconnect),()=>{n("remove wc listeners"),i.emitter.off("message",handleMessage),i.emitter.off("disconnect",handleDisconnect)}}}async function handleMessage(e){let{type:t,data:i}=e;n("WC Message",t,i),"display_uri"===t&&o(i)}async function handleDisconnect(){n("WC Disconnect"),i&&connectWallet(i)}async function connectWallet(e){let n=await a({connector:e});return!!n&&n}async function connectWalletConnect(e){try{await connectWallet(e)}catch(t){n("catch error"),n(t),t.code?4001===t.code?(n("error.code - User rejected"),connectWalletConnect(e)):n("error.code - Unknown Error"):n("WalletConnect cannot connect.",t)}}},[e,i,r]),{uri:t}}({enabled:e}),{address:o,chain:i}=(0,c.m)(),r=useChainIsSupported(null==i?void 0:i.id),a=useChains();return(0,j.jsx)(nJ.Provider,{value:{connect:{getUri:e=>t},dapp:{chains:a},account:o?{chain:i,chainIsSupported:r,address:o}:void 0},children:n})},useWeb3=()=>S.useContext(nJ);function useIsMobile(){let[e,n]=(0,S.useState)(isMobile());return(0,S.useEffect)(()=>{let handleResize=()=>{n(isMobile())};return window.addEventListener("resize",handleResize),()=>window.removeEventListener("resize",handleResize)},[]),e}let nq=V.div`
  position: relative;
`,nK=A.F4`
0%{ opacity:0; }
100%{ opacity:1; }
`,n$=V.div`
  ...
  span {
    ...
    animation: ${nK} 300ms ease 1000ms both;
...
`,n1=V.div`
  ...
  ${({$mobile:e,$height:n,$mobileDirection:t})=>e&&"horizontal"===t?A.iv`
          overflow-x: scroll;
          margin: 0 -24px;
          padding: 0 24px;
...
`,Alert=({children:e,error:n,icon:t})=>(0,j.jsxs)(n0,{$error:n,children:[t&&(0,j.jsx)(n2,{children:t}),(0,j.jsx)("div",{children:e})]});Alert.displayName="Alert";let useLastConnector=()=>{let{storage:e}=(0,d.Z)(),[n,t]=(0,S.useState)(null);return(0,S.useEffect)(()=>{let init=async()=>{let n=await (null==e?void 0:e.getItem("recentConnectorId"));t(null!=n?n:"")};init()},[]),{lastConnectorId:n,updateLastConnectorId:n=>{null==e||e.setItem("recentConnectorId",n)}}},ConnectorList=()=>{var e;let n=useContext(),t=useIsMobile(),o=useWallets(),{lastConnectorId:i}=useLastConnector(),r=(null===(e=n.options)||void 0===e?void 0:e.hideRecentBadge)||"walletConnect"===i?o:[...o.filter(e=>i===e.connector.id),...o.filter(e=>i!==e.connector.id)];return(0,j.jsxs)(ScrollArea,{mobileDirection:"horizontal",children:[0===r.length&&(0,j.jsx)(Alert,{error:!0,children:"No connectors found in ConnectKit config."}),r.length>0&&(0,j.jsx)(nX,{$mobile:t,$totalResults:r.length,children:r.map(e=>(0,j.jsx)(ConnectorItem,{wallet:e,isRecent:e.id===i},e.id))})]})},ConnectorItem=({wallet:e,isRecent:n})=>{var t,o,i,r;let{connect:{getUri:a}}=useWeb3(),s=a(),c=useIsMobile(),l=useContext(),{connect:d}=useConnect(),p=!e.isInstalled&&c||e.shouldDeeplinkDesktop&&!c?null===(t=e.getWalletConnectDeeplink)||void 0===t?void 0:t.call(e,null!=s?s:""):void 0,h=c&&isWalletConnectConnector(e.id),u=("safari"===detectBrowser()||"ios"===detectBrowser())&&isCoinbaseWalletConnector(e.connector.id);return(h||u)&&(p=void 0),(0,j.jsxs)(nG,{type:"button",as:p?"a":void 0,href:p||void 0,disabled:l.route!==of.CONNECTORS,onClick:p?void 0:()=>{h?l.setRoute(of.MOBILECONNECTORS):(u&&d({connector:null==e?void 0:e.connector}),l.setRoute(of.CONNECT),l.setConnector({id:e.id}))},children:[(0,j.jsx)(nP,{"data-small":e.iconShouldShrink,"data-shape":e.iconShape,children:null!==(o=e.iconConnector)&&void 0!==o?o:e.icon}),(0,j.jsxs)(nV,{children:[c&&null!==(i=e.shortName)&&void 0!==i?i:e.name,!(null===(r=l.options)||void 0===r?void 0:r.hideRecentBadge)&&n&&(0,j.jsx)(nQ,{children:(0,j.jsx)("span",{children:"Recent"})})]})]})},Wallets=()=>{var e,n,t,o,i;let r=useContext(),a=useLocales({}),s=useIsMobile();return(0,j.jsxs)(el,{style:{width:312},children:[(0,j.jsx)(ConnectorList,{}),s?(0,j.jsx)(j.Fragment,{children:(0,j.jsxs)(nD,{children:[(0,j.jsxs)(eu,{style:{padding:0,textAlign:"left"},children:[(0,j.jsx)(ex,{$small:!0,children:a.connectorsScreen_h1}),(0,j.jsx)(eg,{children:a.connectorsScreen_p})]}),(0,j.jsxs)(nR,{children:[!(null===(e=r.options)||void 0===e?void 0:e.hideQuestionMarkCTA)&&(0,j.jsx)(Button,{variant:"tertiary",onClick:()=>r.setRoute(of.ABOUT),children:a.learnMore}),!(null===(n=r.options)||void 0===n?void 0:n.hideNoWalletCTA)&&(0,j.jsx)(Button,{variant:"tertiary",onClick:()=>r.setRoute(of.ONBOARDING),children:a.getWallet})]})]})}):(0,j.jsx)(j.Fragment,{children:!(null===(t=r.options)||void 0===t?void 0:t.hideNoWalletCTA)&&(0,j.jsx)(nH,{children:(0,j.jsxs)(nZ,{onClick:()=>r.setRoute(of.ONBOARDING),children:[(0,j.jsx)(WalletIcon$1,{})," ",a.connectorsScreen_newcomer]})})}),(null===(o=r.options)||void 0===o?void 0:o.disclaimer)&&(0,j.jsx)(e_,{style:{visibility:"hidden",pointerEvents:"none"},children:(0,j.jsx)("div",{children:null===(i=r.options)||void 0===i?void 0:i.disclaimer})})]})},n3=V.div`
  text-align: center;
...
`,n8=V.div`
  ...
  ${e=>e.$disabled&&A.iv`
      ...
      opacity: 0.4;
      ${n3} {
        animation: ${n9} 1s infinite ease-in-out;
      }
    `}
`,n6=V.div``;function useWalletConnectModal(){let{log:e}=useContext(),{connectAsync:n,connectors:t}=useConnect(),[o,i]=(0,S.useState)(!1);return{isOpen:o,open:async()=>{let o=document.createElement("style");o.innerHTML="w3m-modal, wcm-modal{ --wcm-z-index: 2147483647; --w3m-z-index:2147483647; }",document.head.appendChild(o);let r=t.find(e=>isWalletConnectConnector(e.id));if(r)try{let t=await r.getProvider(),a=t.rpc.projectId,s=(0,z.a)({projectId:a,showQrModal:!0});i(!0);try{await n({connector:s})}catch(n){e("WalletConnect",n)}i(!1),document.head.removeChild(o)}catch(n){e("Could not get WalletConnect provider",n)}else e("No WalletConnect connector available")}}}let n7=V(L.E.div)`
  ...
  ${e=>e.$clipboard?A.iv`
        ...
        `}
`,CopyToClipboardIcon=({copied:e,small:n})=>(0,j.jsx)(n7,{$clipboard:e,children:(0,j.jsx)(CopyToClipboardIcon$1,{style:{transform:n?"scale(1)":"translateX(3px) scale(1.5)",opacity:n||e?1:.3}})}),te=V.div`
...
`,CopyToClipboard=({string:e,children:n,variant:t})=>{let o;let[i,r]=(0,S.useState)(!1),onCopy=()=>{if(!e)return;let n=e.trim();navigator.clipboard&&navigator.clipboard.writeText(n),r(!0),clearTimeout(o),o=setTimeout(()=>r(!1),1e3)};return"button"===t?(0,j.jsx)(Button,{disabled:!e,onClick:onCopy,icon:(0,j.jsx)(CopyToClipboardIcon,{copied:i}),children:n}):(0,j.jsx)(te,{onClick:onCopy,$disabled:!e,children:(0,j.jsxs)(tn,{children:[n,(0,j.jsx)(CopyToClipboardIcon,{copied:i,small:!0})]})})},tt=(0,j.jsx)("svg",{width:"60",height:"60",viewBox:"0 0 60 60",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,j.jsx)("path",{d:"M30 42V19M19 30.5H42",stroke:"var(--ck-body-color-muted)",strokeWidth:"3",strokeLinecap:"round"})}),MobileConnectors=()=>{var e,n;let t=useContext(),o=useLocales(),{connect:{getUri:i}}=useWeb3(),r=i(),{open:a,isOpen:s}=useWalletConnectModal(),c=useWallets(),l=null!==(e=Object.keys(Z).filter(e=>{let n=Z[e];return!c.find(n=>n.connector.id===e)&&!!n.getWalletConnectDeeplink}))&&void 0!==e?e:[],connectWallet=e=>{var n;let t=null===(n=e.getWalletConnectDeeplink)||void 0===n?void 0:n.call(e,r);t&&(window.location.href=t)};return(0,j.jsx)(el,{style:{width:312},children:(0,j.jsxs)(n6,{children:[(0,j.jsx)(eu,{style:{paddingBottom:0},children:(0,j.jsx)(ScrollArea,{height:340,children:(0,j.jsxs)(n8,{$disabled:!r,children:[l.sort((e,n)=>{var t,o,i,r;let a=Z[e],s=Z[n],c=null!==(o=null!==(t=a.name)&&void 0!==t?t:a.shortName)&&void 0!==o?o:e,l=null!==(r=null!==(i=s.name)&&void 0!==i?i:s.shortName)&&void 0!==r?r:n;return c.localeCompare(l)}).filter(e=>!("coinbaseWallet"===e||"com.coinbase.wallet"===e)).map((e,n)=>{let t=Z[e],{name:o,shortName:i,iconConnector:r,icon:a}=t;return(0,j.jsxs)(n3,{onClick:()=>connectWallet(t),style:{animationDelay:`${50*n}ms`},children:[(0,j.jsx)(n5,{$outline:!0,children:null!=r?r:a}),(0,j.jsx)(n4,{children:null!=i?i:o})]},n)}),(0,j.jsxs)(n3,{onClick:a,$waiting:s,children:[(0,j.jsx)(n5,{style:{background:"var(--ck-body-background-secondary)"},children:s?(0,j.jsx)("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"},children:(0,j.jsx)("div",{style:{width:"50%"},children:(0,j.jsx)(Spinner$4,{})})}):tt}),(0,j.jsx)(n4,{children:o.more})]})]})})}),(null===(n=t.options)||void 0===n?void 0:n.walletConnectCTA)!=="modal"&&(0,j.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14,paddingTop:8},children:(0,j.jsx)(CopyToClipboard,{variant:"button",string:r,children:o.copyToClipboard})})]})})},to=V(L.E.div)`
  display: flex;
  flex-direction: column;
  gap: 6px;
  position: relative;
...
`,tc=V(L.E.div)`
  ...
  ${e=>e.$shake&&A.iv`
      animation: ${ti} 220ms ease-out both;
      &:before {
        animation: ${tr} 220ms ease-out 750ms both;
      }
    `}
`,tl=V(L.E.button)`
  z-index: 5;
...
`,Tooltip=({children:e,message:n,open:t,xOffset:o=0,yOffset:i=0,delay:r})=>{var a;let s=useContext(),c=useThemeContext();if(null===(a=s.options)||void 0===a?void 0:a.hideTooltips)return(0,j.jsx)(j.Fragment,{children:e});let[l,d]=(0,S.useState)(!1),[p,h]=(0,S.useState)(!1),[u,x]=(0,S.useState)("small"),[g,b]=(0,S.useState)(!1),[C]=(0,S.useState)(s.route),m=(0,S.useRef)(null),[f,v]=(0,W.Z)({debounce:g?0:220,offsetSize:!0,scroll:!0}),checkBounds=()=>{let e=!1,n=o+v.left+v.width,t=i+v.top+.5*v.height;return(n>window.innerWidth||n<0||t>window.innerHeight||t<0)&&(e=!0),e},k="undefined"!=typeof window?S.useLayoutEffect:S.useEffect;return k(()=>{if(!m.current||v.top+v.bottom+v.left+v.right+v.height+v.width===0)return;let e=o+v.left+v.width,n=i+v.top+.5*v.height;g||0===e||0===n||b(!0),m.current.style.left=`${e}px`,m.current.style.top=`${n}px`,x(m.current.offsetHeight<=40?"small":"large"),h(checkBounds())},[v,t,l]),(0,S.useEffect)(()=>{s.open||d(!1)},[s.open]),(0,S.useEffect)(()=>{d(!!t)},[t]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(L.E.div,{ref:f,style:void 0===t?{cursor:"help"}:{},onHoverStart:()=>d(!0),onHoverEnd:()=>d(!1),onClick:()=>d(!1),children:e}),(0,j.jsx)(Portal,{children:(0,j.jsx)(M.M,{children:C===s.route&&!p&&l&&(0,j.jsx)(ee,{$useTheme:c.theme,$useMode:c.mode,$customTheme:c.customTheme,children:(0,j.jsx)(tp,{children:(0,j.jsxs)(th,{role:"tooltip",$size:u,ref:m,initial:"collapsed",animate:g?"open":{},exit:"collapsed",variants:{collapsed:{transformOrigin:"20px 50%",opacity:0,scale:.9,z:.01,y:"-50%",x:20,transition:{duration:.1}},open:{willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:"-50%",x:20,transition:{ease:[.76,0,.24,1],duration:.15,delay:r||.5}}},children:[n,(0,j.jsx)(tu,{$size:u})]})})})})})]})},tx=V(L.E.div)`
  z-index: 4;
  position: relative;
  overflow: hidden;
  svg {
...
`,CircleSpinner=({logo:e,smallLogo:n,connecting:t=!0,unavailable:o=!1,countdown:i=!1})=>(0,j.jsxs)(tj,{transition:{duration:.5,ease:[.175,.885,.32,.98]},children:[(0,j.jsx)(tS,{$small:!o&&n,style:o?{borderRadius:0}:void 0,children:e}),(0,j.jsx)(tE,{children:(0,j.jsxs)(M.M,{children:[t&&(0,j.jsx)(tL,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,transition:{duration:i?1:0}},children:(0,j.jsxs)("svg",{"aria-hidden":"true",width:"102",height:"102",viewBox:"0 0 102 102",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,j.jsx)("path",{d:"M52 100C24.3858 100 2 77.6142 2 50",stroke:"url(#paint0_linear_1943_4139)",strokeWidth:"3.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,j.jsx)("defs",{children:(0,j.jsxs)("linearGradient",{id:"paint0_linear_1943_4139",x1:"2",y1:"48.5",x2:"53",y2:"100",gradientUnits:"userSpaceOnUse",children:[(0,j.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,j.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]})},"Spinner"),i&&(0,j.jsxs)(tN,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.25},children:[(0,j.jsx)("div",{}),(0,j.jsx)("div",{})]},"ExpiringSpinner")]})})]}),tM={CONNECTED:"connected",CONNECTING:"connecting",EXPIRING:"expiring",FAILED:"failed",REJECTED:"rejected",NOTCONNECTED:"notconnected",UNAVAILABLE:"unavailable"},tI={initial:{willChange:"transform,opacity",position:"relative",opacity:0,scale:.95},animate:{position:"relative",opacity:1,scale:1,transition:{ease:[.16,1,.3,1],duration:.4,delay:.05,position:{delay:0}}},exit:{position:"absolute",opacity:0,scale:.95,transition:{ease:[.16,1,.3,1],duration:.3}}},ConnectWithInjector=({switchConnectMethod:e,forceState:n})=>{var t,o,i,r,a,s,c,l;let d;let{connect:p}=useConnect({mutation:{onMutate:e=>{e.connector?y(tM.CONNECTING):y(tM.UNAVAILABLE)},onError(e){console.error(e)},onSettled(e,n){if(n){if(m(!0),setTimeout(()=>m(!1),3500),n.code)switch(n.code){case -32002:y(tM.NOTCONNECTED);break;case 4001:y(tM.REJECTED);break;default:y(tM.FAILED)}else n.message&&("User rejected request"===n.message?y(tM.REJECTED):y(tM.FAILED))}setTimeout(h,100)}}}),{triggerResize:h,connector:u}=useContext(),x=u.id,g=useWallet(x),b={name:null==g?void 0:g.name,shortName:null!==(t=null==g?void 0:g.shortName)&&void 0!==t?t:null==g?void 0:g.name,icon:null!==(o=null==g?void 0:g.iconConnector)&&void 0!==o?o:null==g?void 0:g.icon,iconShape:null!==(i=null==g?void 0:g.iconShape)&&void 0!==i?i:"circle",iconShouldShrink:null==g?void 0:g.iconShouldShrink},[C,m]=(0,S.useState)(!1);(0,S.useState)(9);let f=detectBrowser(),v=null===(r=null==g?void 0:g.downloadUrls)||void 0===r?void 0:r[f],k=(null==g?void 0:g.downloadUrls)?{name:Object.keys(null==g?void 0:g.downloadUrls)[0],label:(null===(a=Object.keys(null==g?void 0:g.downloadUrls)[0])||void 0===a?void 0:a.charAt(0).toUpperCase())+(null===(s=Object.keys(null==g?void 0:g.downloadUrls)[0])||void 0===s?void 0:s.slice(1)),url:null==g?void 0:g.downloadUrls[Object.keys(null==g?void 0:g.downloadUrls)[0]]}:void 0,[w,y]=(0,S.useState)(n||((null==g?void 0:g.isInstalled)?tM.CONNECTING:tM.UNAVAILABLE)),E=useLocales({CONNECTORNAME:b.name,CONNECTORSHORTNAME:null!==(c=b.shortName)&&void 0!==c?c:b.name,SUGGESTEDEXTENSIONBROWSER:null!==(l=null==k?void 0:k.label)&&void 0!==l?l:"your browser"}),runConnect=async()=>{(null==g?void 0:g.isInstalled)&&(null==g?void 0:g.connector)?p({connector:null==g?void 0:g.connector}):y(tM.UNAVAILABLE)};return((0,S.useEffect)(()=>{if(w!==tM.UNAVAILABLE)return d=setTimeout(runConnect,600),()=>{clearTimeout(d)}},[]),g)?isWalletConnectConnector(null==g?void 0:g.connector.id)?(0,j.jsx)(el,{children:(0,j.jsxs)(ta,{children:[(0,j.jsx)(ep,{children:"Invalid State"}),(0,j.jsx)(eu,{children:(0,j.jsx)(Alert,{children:"WalletConnect does not have an injection flow. This state should never happen."})})]})}):(0,j.jsx)(el,{children:(0,j.jsxs)(ta,{children:[(0,j.jsx)(ts,{children:(0,j.jsxs)(tc,{$shake:w===tM.FAILED||w===tM.REJECTED,$circle:"circle"===b.iconShape,children:[(0,j.jsx)(M.M,{children:(w===tM.FAILED||w===tM.REJECTED)&&(0,j.jsx)(tl,{"aria-label":"Retry",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},whileTap:{scale:.9},transition:{duration:.1},onClick:runConnect,children:(0,j.jsx)(td,{children:(0,j.jsx)(Tooltip,{open:C&&(w===tM.FAILED||w===tM.REJECTED),message:E.tryAgainQuestion,xOffset:-6,children:(0,j.jsx)(RetryIconCircle,{})})})})}),"circle"===b.iconShape?(0,j.jsx)(CircleSpinner,{logo:w===tM.UNAVAILABLE?(0,j.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:b.icon}):(0,j.jsx)(j.Fragment,{children:b.icon}),smallLogo:b.iconShouldShrink,connecting:w===tM.CONNECTING,unavailable:w===tM.UNAVAILABLE}):(0,j.jsx)(SquircleSpinner,{logo:w===tM.UNAVAILABLE?(0,j.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:b.icon}):(0,j.jsx)(j.Fragment,{children:b.icon}),connecting:w===tM.CONNECTING})]})}),(0,j.jsx)(eh,{children:(0,j.jsxs)(M.M,{initial:!1,children:[w===tM.FAILED&&(0,j.jsx)(to,{initial:"initial",animate:"animate",exit:"exit",variants:tI,children:(0,j.jsxs)(eu,{children:[(0,j.jsxs)(ex,{$error:!0,children:[(0,j.jsx)(AlertIcon,{}),E.injectionScreen_failed_h1]}),(0,j.jsx)(eg,{children:E.injectionScreen_failed_p})]})},tM.FAILED),w===tM.REJECTED&&(0,j.jsx)(to,{initial:"initial",animate:"animate",exit:"exit",variants:tI,children:(0,j.jsxs)(eu,{style:{paddingBottom:28},children:[(0,j.jsx)(ex,{children:E.injectionScreen_rejected_h1}),(0,j.jsx)(eg,{children:E.injectionScreen_rejected_p})]})},tM.REJECTED),(w===tM.CONNECTING||w===tM.EXPIRING)&&(0,j.jsx)(to,{initial:"initial",animate:"animate",exit:"exit",variants:tI,children:(0,j.jsxs)(eu,{style:{paddingBottom:28},children:[(0,j.jsx)(ex,{children:"injected"===g.connector.id?E.injectionScreen_connecting_injected_h1:E.injectionScreen_connecting_h1}),(0,j.jsx)(eg,{children:"injected"===g.connector.id?E.injectionScreen_connecting_injected_p:E.injectionScreen_connecting_p})]})},tM.CONNECTING),w===tM.CONNECTED&&(0,j.jsx)(to,{initial:"initial",animate:"animate",exit:"exit",variants:tI,children:(0,j.jsxs)(eu,{children:[(0,j.jsxs)(ex,{$valid:!0,children:[(0,j.jsx)(TickIcon,{})," ",E.injectionScreen_connected_h1]}),(0,j.jsx)(eg,{children:E.injectionScreen_connected_p})]})},tM.CONNECTED),w===tM.NOTCONNECTED&&(0,j.jsx)(to,{initial:"initial",animate:"animate",exit:"exit",variants:tI,children:(0,j.jsxs)(eu,{children:[(0,j.jsx)(ex,{children:E.injectionScreen_notconnected_h1}),(0,j.jsx)(eg,{children:E.injectionScreen_notconnected_p})]})},tM.NOTCONNECTED),w===tM.UNAVAILABLE&&(0,j.jsx)(to,{initial:"initial",animate:"animate",exit:"exit",variants:tI,children:v?(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(eu,{style:{paddingBottom:18},children:[(0,j.jsx)(ex,{children:E.injectionScreen_install_h1}),(0,j.jsx)(eg,{children:E.injectionScreen_install_p})]}),!g.isInstalled&&v&&(0,j.jsx)(Button,{href:v,icon:(0,j.jsx)(ty,{}),children:E.installTheExtension})]}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(eu,{style:{paddingBottom:12},children:[(0,j.jsx)(ex,{children:E.injectionScreen_unavailable_h1}),(0,j.jsx)(eg,{children:E.injectionScreen_unavailable_p})]}),!g.isInstalled&&k&&(0,j.jsxs)(Button,{href:null==k?void 0:k.url,icon:(0,j.jsx)(ty,{browser:null==k?void 0:k.name}),children:["Install on ",null==k?void 0:k.label]})]})},tM.UNAVAILABLE)]})})]})}):(0,j.jsx)(el,{children:(0,j.jsxs)(ta,{children:[(0,j.jsx)(ep,{children:"Invalid State"}),(0,j.jsx)(eu,{children:(0,j.jsx)(Alert,{children:"No connectors match the id given. This state should never happen."})})]})})},tA=V(L.E.div)`
  z-index: 3;
  position: relative;
  overflow: hidden;
  height: 0;
...
`,tO=V(L.E.div)`
  ...
  &:after {
    ...
    animation: ${tF} 1000ms linear infinite both;
  }
`,tW=V(L.E.div)`
  z-index: 6;
  position: absolute;
...
`,tT=V(L.E.div)`
  ...
  ${e=>e.$wcLogo?A.iv`
        ...
        `}
`,generateMatrix=(e,n)=>{let t=Array.prototype.slice.call(B.create(e,{errorCorrectionLevel:n}).modules.data,0),o=Math.sqrt(t.length);return t.reduce((e,n,t)=>(t%o==0?e.push([n]):e[e.length-1].push(n))&&e,[])};function QRCode({ecl:e="M",size:n=200,uri:t,clearArea:o=!1,image:i,imageBackground:r="transparent"}){let a=o?76:0,s=n-20,c=(0,S.useMemo)(()=>{let n=[],o=generateMatrix(t,e),c=s/o.length;if([{x:0,y:0},{x:1,y:0},{x:0,y:1}].forEach(({x:e,y:t})=>{let i=(o.length-7)*c*e,r=(o.length-7)*c*t;for(let o=0;o<3;o++)n.push((0,j.jsx)("rect",{fill:o%2!=0?"var(--ck-qr-background, var(--ck-body-background))":"var(--ck-qr-dot-color)",rx:-((o-2)*5)+(0===o?2:3),ry:-((o-2)*5)+(0===o?2:3),width:c*(7-2*o),height:c*(7-2*o),x:i+c*o,y:r+c*o},`${o}-${e}-${t}`))}),i){let e=(o.length-7)*c*1,t=(o.length-7)*c*1;n.push((0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)("rect",{fill:r,rx:12,ry:12,width:7*c,height:7*c,x:e+0*c,y:t+0*c}),(0,j.jsx)("foreignObject",{width:7*c,height:7*c,x:e+0*c,y:t+0*c,children:(0,j.jsx)("div",{style:{borderRadius:12,overflow:"hidden"},children:i})})]}))}let l=Math.floor((a+25)/c),d=o.length/2-l/2,p=o.length/2+l/2-1;return o.forEach((e,t)=>{e.forEach((e,r)=>{o[t][r]&&!(t<7&&r<7||t>o.length-8&&r<7||t<7&&r>o.length-8)&&(i||!(t>d&&t<p&&r>d&&r<p))&&n.push((0,j.jsx)("circle",{cx:t*c+c/2,cy:r*c+c/2,fill:"var(--ck-qr-dot-color)",r:c/3},`circle-${t}-${r}`))})}),n},[e,s,t]);return(0,j.jsxs)("svg",{height:s,width:s,viewBox:`0 0 ${s} ${s}`,style:{width:s,height:s},children:[(0,j.jsx)("rect",{fill:"transparent",height:s,width:s}),c]})}function CustomQRCode({value:e,image:n,imageBackground:t,imagePosition:o="center",tooltipMessage:i}){let r=function(){let[e,n]=(0,S.useState)({width:0,height:0});return(0,S.useEffect)(()=>{function handleResize(){n({width:window.innerWidth,height:window.innerHeight})}return window.addEventListener("resize",handleResize),handleResize(),()=>window.removeEventListener("resize",handleResize)},[]),e}(),a=r.width>920&&i?(0,j.jsx)(Tooltip,{xOffset:139,yOffset:5,delay:.1,message:i,children:n}):n;return(0,j.jsx)(tA,{children:(0,j.jsxs)(t_,{children:[n&&(0,j.jsx)(tW,{children:(0,j.jsx)(tT,{$wcLogo:"center"!==o,style:{background:"center"===o?t:void 0},children:a})}),(0,j.jsx)(M.M,{initial:!1,children:e?(0,j.jsx)(L.E.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:(0,j.jsx)(QRCode,{uri:e,size:288,ecl:"M",clearArea:!!("center"===o&&n)})},e):(0,j.jsxs)(tO,{initial:{opacity:.1},animate:{opacity:.1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:[(0,j.jsx)("span",{}),(0,j.jsx)("span",{}),(0,j.jsx)("span",{}),(0,j.jsx)("div",{})]})})]})})}CustomQRCode.displayName="CustomQRCode";let tz=V(L.E.div)`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,ScanIconWithLogos=({logo:e})=>{let n=[(0,j.jsx)(R.MetaMask,{background:!0}),(0,j.jsx)(R.Coinbase,{background:!0}),(0,j.jsx)(R.Crypto,{}),(0,j.jsx)(R.ImToken,{}),(0,j.jsx)(R.Argent,{}),(0,j.jsx)(R.Trust,{})];return(0,j.jsx)(tz,{children:(0,j.jsxs)("svg",{"aria-hidden":"true",width:"47",height:"52",viewBox:"0 0 47 52",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,j.jsxs)("g",{mask:"url(#gradient-mask)",children:[(0,j.jsx)("path",{d:"M7 14.5C7 11.4624 9.46243 9 12.5 9H31.5C34.5376 9 37 11.4624 37 14.5V47H7V14.5Z",fill:"var(--ck-graphic-scaniconwithlogos-04)"}),e?(0,j.jsx)("foreignObject",{x:"13",y:"21",width:"18",height:"18",rx:"5",children:(0,j.jsx)("div",{style:{overflow:"hidden",borderRadius:5},children:e})}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)("foreignObject",{x:"12",y:"15",width:"9",height:"9",rx:"2.5",children:(0,j.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[0]})}),(0,j.jsx)("foreignObject",{x:"23",y:"15",width:"9",height:"9",rx:"2.5",children:(0,j.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[1]})}),(0,j.jsx)("foreignObject",{x:"12",y:"26",width:"9",height:"9",rx:"2.5",children:(0,j.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:(0,j.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[2]})})}),(0,j.jsx)("foreignObject",{x:"23",y:"26",width:"9",height:"9",rx:"2.5",children:(0,j.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[3]})}),(0,j.jsx)("foreignObject",{x:"12",y:"37",width:"9",height:"9",rx:"2.5",children:(0,j.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[4]})}),(0,j.jsx)("foreignObject",{x:"23",y:"37",width:"9",height:"9",rx:"2.5",children:(0,j.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[5]})})]}),(0,j.jsx)("path",{d:"M36 47V13.7143C36 11.1107 33.8893 9 31.2857 9H12.7143C10.1107 9 8 11.1107 8 13.7143V47",stroke:"url(#paint0_linear_924_12568)",strokeWidth:"2"}),(0,j.jsx)("path",{d:"M15 10H29C29 11.1046 28.1046 12 27 12H17C15.8954 12 15 11.1046 15 10Z",fill:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,j.jsx)("rect",{x:"1",y:"47",width:"43",height:"5",fill:"var(--ck-tooltip-background)"}),(0,j.jsx)("rect",{x:"22",y:"1",width:"24",height:"24",rx:"12",fill:"var(--ck-graphic-scaniconwithlogos-03)",stroke:"var(--ck-tooltip-background)",strokeWidth:"2"}),(0,j.jsx)("rect",{x:"34.5",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,j.jsx)("rect",{x:"31",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,j.jsx)("rect",{x:"31",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,j.jsx)("rect",{x:"34.5",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,j.jsx)("path",{d:"M28.5 10.5V9C28.5 8.17157 29.1716 7.5 30 7.5H31.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,j.jsx)("path",{d:"M36.5 7.5L38 7.5C38.8284 7.5 39.5 8.17157 39.5 9L39.5 10.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,j.jsx)("path",{d:"M39.5 15.5L39.5 17C39.5 17.8284 38.8284 18.5 38 18.5L36.5 18.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,j.jsx)("path",{d:"M31.5 18.5L30 18.5C29.1716 18.5 28.5 17.8284 28.5 17L28.5 15.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})]}),(0,j.jsxs)("defs",{children:[(0,j.jsxs)("linearGradient",{id:"paint0_linear_924_12568",x1:"22",y1:"8.2549",x2:"22",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,j.jsx)("stop",{stopColor:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,j.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-scaniconwithlogos-02)"})]}),(0,j.jsxs)("linearGradient",{id:"linear-gradient-mask",x1:"47",y1:"42",x2:"47",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,j.jsx)("stop",{stopColor:"white"}),(0,j.jsx)("stop",{offset:"1",stopColor:"black",stopOpacity:"0"})]}),(0,j.jsx)("mask",{id:"gradient-mask",children:(0,j.jsx)("rect",{x:"0",y:"0",width:"47",height:"52",fill:"url(#linear-gradient-mask)"})})]})]})})},ConnectWithQRCode=({switchConnectMethod:e})=>{var n,t,o,i,r,a,s,c;let l=useContext(),d=l.connector.id,p=useWallet(l.connector.id),{open:h,isOpen:u}=useWalletConnectModal(),{connect:{getUri:x}}=useWeb3(),g=x(d),b=g?null!==(t=null===(n=null==p?void 0:p.getWalletConnectDeeplink)||void 0===n?void 0:n.call(p,g))&&void 0!==t?t:g:void 0,C=useLocales({CONNECTORNAME:null==p?void 0:p.name});if(!p)return(0,j.jsxs)(j.Fragment,{children:["Wallet not found ",l.connector.id]});let m=null==p?void 0:p.downloadUrls,f={chrome:null==m?void 0:m.chrome,firefox:null==m?void 0:m.firefox,brave:null==m?void 0:m.brave,edge:null==m?void 0:m.edge,safari:null==m?void 0:m.safari};detectBrowser();let v=m&&0!==Object.keys(m).length;f&&(Object.keys(f)[0],null===(o=Object.keys(f)[0])||void 0===o||o.charAt(0).toUpperCase(),null===(i=Object.keys(f)[0])||void 0===i||i.slice(1),f[Object.keys(f)[0]]);let k=isWalletConnectConnector(d);return(0,j.jsxs)(el,{children:[(0,j.jsxs)(eu,{style:{paddingBottom:8,gap:14},children:[(0,j.jsx)(CustomQRCode,{value:b,image:null==p?void 0:p.icon,tooltipMessage:isWalletConnectConnector(d)?(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(ScanIconWithLogos,{}),(0,j.jsx)("span",{children:C.scanScreen_tooltip_walletConnect})]}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(ScanIconWithLogos,{logo:null==p?void 0:p.icon}),(0,j.jsx)("span",{children:C.scanScreen_tooltip_default})]})}),k?(0,j.jsx)(OrDivider,{}):v&&(0,j.jsx)(OrDivider,{children:C.dontHaveTheApp})]}),k&&(0,j.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14},children:[(null===(r=l.options)||void 0===r?void 0:r.walletConnectCTA)!=="modal"&&(0,j.jsx)(CopyToClipboard,{variant:"button",string:b,children:(null===(a=l.options)||void 0===a?void 0:a.walletConnectCTA)==="link"?C.copyToClipboard:C.copyCode}),(null===(s=l.options)||void 0===s?void 0:s.walletConnectCTA)!=="link"&&(0,j.jsx)(Button,{icon:(0,j.jsx)(ExternalLinkIcon,{}),onClick:h,disabled:u,waiting:u,children:(null===(c=l.options)||void 0===c?void 0:c.walletConnectCTA)==="modal"?C.useWalletConnectModal:C.useModal})]}),v&&(0,j.jsx)(j.Fragment,{children:(0,j.jsx)(Button,{onClick:()=>{l.setRoute(of.DOWNLOAD)},download:!0,children:C.getWalletName})})]})},tB={QRCODE:"qrcode",INJECTOR:"injector"},ConnectUsing=()=>{let e=useContext(),n=useWallet(e.connector.id),t=!(null==n?void 0:n.isInstalled)&&(null==n?void 0:n.getWalletConnectDeeplink),[o,i]=(0,S.useState)(t?tB.QRCODE:tB.INJECTOR);return((0,S.useEffect)(()=>{let checkProvider=async()=>{let t=await (null==n?void 0:n.connector.getProvider());t||(i(tB.QRCODE),setTimeout(e.triggerResize,10))};o===tB.INJECTOR&&checkProvider()},[]),n)?(0,j.jsxs)(M.M,{children:[o===tB.QRCODE&&(0,j.jsx)(L.E.div,{initial:"initial",animate:"animate",exit:"exit",variants:e$,children:(0,j.jsx)(ConnectWithQRCode,{switchConnectMethod:e=>{i(tB.INJECTOR)}})},tB.QRCODE),o===tB.INJECTOR&&(0,j.jsx)(L.E.div,{initial:"initial",animate:"animate",exit:"exit",variants:e$,children:(0,j.jsx)(ConnectWithInjector,{switchConnectMethod:e=>{i(tB.QRCODE)}})},tB.INJECTOR)]}):(0,j.jsxs)(Alert,{children:["Connector not found ",e.connector.id]})},DownloadApp=()=>{var e,n,t;let o=useContext(),i=useWallet(o.connector.id),r=useLocales({CONNECTORNAME:null==i?void 0:i.name});if(!i)return(0,j.jsx)(j.Fragment,{children:"Wallet not found"});let a={ios:null===(e=i.downloadUrls)||void 0===e?void 0:e.ios,android:null===(n=i.downloadUrls)||void 0===n?void 0:n.android,redirect:null===(t=i.downloadUrls)||void 0===t?void 0:t.download},s=a.ios&&a.android?r.downloadAppScreen_iosAndroid:a.ios?r.downloadAppScreen_ios:r.downloadAppScreen_android;return(0,j.jsx)(el,{children:(0,j.jsxs)(eu,{style:{paddingBottom:4,gap:14},children:[a.redirect&&(0,j.jsx)(CustomQRCode,{value:a.redirect}),!a.redirect&&(0,j.jsx)(j.Fragment,{children:"No download link available"}),(0,j.jsx)(eg,{style:{fontSize:15,lineHeight:"20px",padding:"0 12px"},children:s})]})})},tD=V(L.E.div)`
  padding: 18px 0 20px;
  @media only screen and (max-width: ${en.mobileWidth}px) {
    padding: 16px 0 20px;
  }
...
`,tV=V(L.E.div)`
  ...
  &:before {
    ...
    opacity: 0.75;
    background-size: 200% 100%;
    animation: ${tG} 1000ms linear infinite both;
  }
`,tP=V(L.E.div)`
  ...
  ${e=>{if(e.$seed){let n=Math.ceil(8*(e.$seed.split("").map(e=>e.charCodeAt(0)).reduce((e,n)=>e+n)%100/100)),t=`0${0===n?1:n}`;return A.iv`
...
`,t3=V(L.E.button)`
  ...
  @media only screen and (min-width: ${en.mobileWidth}px) {
    &:hover {
      &:before {
...
`,t9=(0,j.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,j.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M2 16.75C2.69036 16.75 3.25 17.3096 3.25 18V19C3.25 26.5939 9.40609 32.75 17 32.75V35.25C8.02537 35.25 0.75 27.9746 0.75 19V18C0.75 17.3096 1.30964 16.75 2 16.75Z",fill:"url(#paint0_linear_1288_18701)"}),(0,j.jsx)("defs",{children:(0,j.jsxs)("linearGradient",{id:"paint0_linear_1288_18701",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,j.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,j.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]}),ChainSelectList=({variant:e})=>{let{connector:n,chain:t}=(0,c.m)(),{chains:o,isPending:i,switchChain:r,error:a}=(0,l.o)(),[s,d]=(0,S.useState)(void 0),p=useLocales({}),h=isMobile(),u=(null==a?void 0:a.code)===4902,x=u||!r,handleSwitchNetwork=e=>{r&&(d(e),r({chainId:e}))},{triggerResize:g}=useContext();return(0,j.jsxs)(tq,{style:{marginBottom:void 0!==r?-8:0},children:[(0,j.jsx)(t0,{children:(0,j.jsx)(t2,{children:o.map(o=>{var r;let a=tJ.find(e=>e.id===o.id),c={...a,...o};return(0,j.jsxs)(t3,{$variant:e,disabled:x||c.id===(null==t?void 0:t.id)||i&&s===c.id,onClick:()=>null==handleSwitchNetwork?void 0:handleSwitchNetwork(c.id),style:{opacity:x&&c.id!==(null==t?void 0:t.id)?.4:void 0},children:[(0,j.jsxs)("span",{style:{display:"flex",alignItems:"center",justifyContent:"flex-start",gap:12,color:c.id===(null==t?void 0:t.id)?"var(--ck-dropdown-active-color, inherit)":"inherit"},children:[(0,j.jsxs)(t$,{children:[(0,j.jsx)(t1,{initial:{opacity:0},animate:{opacity:i&&s===c.id?1:0},transition:{ease:[.76,0,.24,1],duration:.15,delay:.1},children:(0,j.jsx)(L.E.div,{animate:h&&isCoinbaseWalletConnector(null==n?void 0:n.id)&&i&&s===c.id?{opacity:[1,0],transition:{delay:4,duration:3}}:{opacity:1},children:t9},`${null==c?void 0:c.id}-${null==c?void 0:c.name}`)}),(0,j.jsx)(tK,{children:null!==(r=c.logo)&&void 0!==r?r:(0,j.jsx)(tX.UnknownChain,{})})]}),c.name]}),"secondary"!==e&&(0,j.jsx)(t5,{children:(0,j.jsxs)(M.M,{initial:!1,exitBeforeEnter:!0,children:[c.id===(null==t?void 0:t.id)&&(0,j.jsx)(L.E.span,{style:{color:"var(--ck-dropdown-active-color, var(--ck-focus-color))",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4,transition:{duration:.1,delay:0}},transition:{ease:[.76,0,.24,1],duration:.3,delay:.2},children:p.connected},"connectedText"),i&&s===c.id&&(0,j.jsx)(L.E.span,{style:{color:"var(--ck-dropdown-pending-color, inherit)",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4},transition:{ease:[.76,0,.24,1],duration:.3,delay:.1},children:(0,j.jsx)(L.E.span,{animate:h&&isCoinbaseWalletConnector(null==n?void 0:n.id)&&{opacity:[1,0],transition:{delay:4,duration:4}},children:p.approveInWallet})},"approveText")]})}),"secondary"===e?(0,j.jsx)(t4,{initial:!1,animate:{opacity:c.id===(null==t?void 0:t.id)?1:0},transition:{duration:.3,ease:"easeOut"}}):c.id===(null==t?void 0:t.id)&&(0,j.jsx)(t4,{layoutId:"activeChain",layout:"position",transition:{duration:.3,ease:"easeOut"}})]},`${null==c?void 0:c.id}-${null==c?void 0:c.name}`)})})}),(0,j.jsx)(M.M,{children:u&&(0,j.jsx)(L.E.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{ease:[.76,0,.24,1],duration:.3},onAnimationStart:g,onAnimationComplete:g,children:(0,j.jsx)("div",{style:{paddingTop:10,paddingBottom:8},children:(0,j.jsxs)(Alert,{children:[p.warnings_walletSwitchingUnsupported," ",p.warnings_walletSwitchingUnsupportedResolve]})})})})]})},t8=V(L.E.div)`
  z-index: 2147483647;
  position: fixed;
  inset: 0;
`,t6=V(L.E.div)`
...
`,oe=V(L.E.div)`
  ...
  user-select: none;
  color: var(--ck-dropdown-color, var(--ck-tooltip-color));
`,ChainSelectDropdown=({children:e,open:n,onClose:t,offsetX:o=0,offsetY:i=8})=>{var r,a,s;let c=useContext(),l=useThemeContext(),d=useLocales(),[p,h]=(0,S.useState)({x:0,y:0});useLockBodyScroll(n);let u=(0,S.useRef)(null);(0,S.useEffect)(()=>{let listener=e=>{var o,i,r;if(n&&("Escape"===e.key&&t(),"ArrowDown"===e.key||"ArrowUp"===e.key)){if(!u.current)return;e.preventDefault();let n=null===(o=u.current)||void 0===o?void 0:o.querySelectorAll(`
            a[href]:not(:disabled),
            button:not(:disabled),
            textarea:not(:disabled),
            input[type="text"]:not(:disabled),
            ...
            input[type="checkbox"]:not(:disabled),
            select:not(:disabled)
          `),t=n[0],a=n[n.length-1];if("ArrowUp"===e.key){if(document.activeElement===t)a.focus();else{let e=null===(i=null==document?void 0:document.activeElement)||void 0===i?void 0:i.previousSibling;for(e||(e=a);e.disabled;)e=e.previousSibling;e.focus()}}else if(document.activeElement===a)t.focus();else{let e=null===(r=null==document?void 0:document.activeElement)||void 0===r?void 0:r.nextSibling;for(e||(e=t);e.disabled;)e=e.nextSibling;e.focus()}}};return document.addEventListener("keydown",listener),()=>{document.removeEventListener("keydown",listener)}},[n]);let x=(0,S.useRef)(null),g=(0,S.useCallback)(e=>{e&&(x.current=e,refresh())},[n]),[b,C]=(0,W.Z)({debounce:120,offsetSize:!0,scroll:!0}),refresh=()=>{if(!x.current||C.top+C.bottom+C.left+C.right+C.height+C.width===0)return;let e=C.left+o,n=C.top+C.height+i;x.current.style.left=`${e}px`,x.current.style.top=`${n}px`},m="undefined"!=typeof window?S.useLayoutEffect:S.useEffect;return m(refresh,[x.current,C,n]),(0,S.useEffect)(refresh,[n,x.current]),(0,S.useEffect)(()=>(refresh(),window.addEventListener("scroll",t),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t),window.removeEventListener("resize",t)}),[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)("div",{ref:b,children:e}),(0,j.jsx)(M.M,{children:n&&(0,j.jsx)(Portal,{children:(0,j.jsx)(ee,{$useTheme:null!==(r=l.theme)&&void 0!==r?r:c.theme,$useMode:null!==(a=l.mode)&&void 0!==a?a:c.mode,$customTheme:null!==(s=l.customTheme)&&void 0!==s?s:c.customTheme,children:(0,j.jsx)(FocusTrap,{children:(0,j.jsxs)(t8,{ref:u,children:[(0,j.jsx)(t6,{onClick:t}),(0,j.jsxs)(t7,{ref:g,style:{left:p.x,top:p.y},initial:"collapsed",animate:"open",exit:"collapsed",variants:{collapsed:{transformOrigin:"0 0",opacity:0,scale:.96,z:.01,y:-4,x:0,transition:{duration:.1}},open:{transformOrigin:"0 0",willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:0,x:0,transition:{ease:[.76,0,.24,1],duration:.15}}},children:[(0,j.jsx)(oe,{children:d.switchNetworks}),(0,j.jsx)(ChainSelectList,{})]})]})})})})})]})},on=V.div`
  --bg: transparent;
  --color: #333;
  ${e=>"string"==typeof e.size?A.iv`
          --width: ${e.size};
          --height: ${e.size};
        `:A.iv`
...
`,oa=(0,j.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,j.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.3592 30.1654C10.0472 29.4491 8.85718 28.524 7.83713 27.424C6.81708 26.324 5.98425 25.0677 5.36889 23.7054C5.20157 23.335 5.05033 22.9567 4.91578 22.5717C4.51465 21.4237 4.26735 20.2308 4.17794 19.0239C4.16599 18.8626 4.13894 18.7041 4.09809 18.5507C3.85023 17.6197 3.09399 16.8738 2.11531 16.7999C0.975331 16.7138 -0.0310983 17.5702 0.0141657 18.7125C0.0223289 18.9185 0.0340286 19.1243 0.049253 19.3298C0.165374 20.8971 0.486545 22.4464 1.00749 23.9373C1.10424 24.2142 1.20764 24.4884 1.31755 24.7596C2.13617 26.7799 3.31595 28.6371 4.80146 30.239C6.28696 31.841 8.04998 33.1573 10.0029 34.1258C10.2651 34.2558 10.5307 34.3796 10.7995 34.4969C12.247 35.1287 13.7676 35.5656 15.3217 35.7995C15.5255 35.8301 15.7298 35.8573 15.9346 35.881C17.0703 36.0122 18.0001 35.0731 18.0001 33.9299C18.0001 32.9484 17.3133 32.1381 16.4036 31.8208C16.2537 31.7685 16.0977 31.7296 15.9377 31.7056C14.7411 31.5255 13.5702 31.1891 12.4556 30.7026C12.0818 30.5394 11.716 30.3601 11.3592 30.1654Z",fill:"url(#paint0_linear_1288_1870)"}),(0,j.jsx)("defs",{children:(0,j.jsxs)("linearGradient",{id:"paint0_linear_1288_1870",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,j.jsx)("stop",{stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0.7"}),(0,j.jsx)("stop",{offset:"1",stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0"})]})})]}),Chain=({id:e,unsupported:n,radius:t="50%",size:o=24})=>{var i;let r=useChainIsSupported(e),a=tJ.find(n=>n.id===e),s=useIsMounted();return s?(0,j.jsx)(on,{size:o,radius:t,children:(0,j.jsxs)(M.M,{initial:!1,children:[(null!=n?n:!r)&&(0,j.jsx)(or,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,j.jsxs)("svg",{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,j.jsx)("path",{d:"M2.61317 11.2501H9.46246C10.6009 11.2501 11.3256 10.3506 11.3256 9.3549C11.3256 9.05145 11.255 8.73244 11.0881 8.43303L7.65903 2.14708C7.659 2.14702 7.65897 2.14696 7.65893 2.1469C7.65889 2.14682 7.65884 2.14673 7.65879 2.14664C7.31045 1.50746 6.6741 1.17871 6.04 1.17871C5.41478 1.17871 4.763 1.50043 4.41518 2.14968L0.993416 8.43476C0.828865 8.72426 0.75 9.04297 0.75 9.3549C0.75 10.3506 1.47471 11.2501 2.61317 11.2501Z",fill:"currentColor",stroke:"var(--ck-body-background, #fff)",strokeWidth:"1.5"}),(0,j.jsx)("path",{d:"M6.03258 7.43916C5.77502 7.43916 5.63096 7.29153 5.62223 7.02311L5.55675 4.96973C5.54802 4.69684 5.74446 4.5 6.02821 4.5C6.3076 4.5 6.51277 4.70131 6.50404 4.9742L6.43856 7.01864C6.42546 7.29153 6.2814 7.43916 6.03258 7.43916ZM6.03258 9.11676C5.7401 9.11676 5.5 8.9065 5.5 8.60677C5.5 8.30704 5.7401 8.09678 6.03258 8.09678C6.32506 8.09678 6.56515 8.30256 6.56515 8.60677C6.56515 8.91097 6.32069 9.11676 6.03258 9.11676Z",fill:"white"})]})}),e?(0,j.jsx)(ot,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:null!==(i=null==a?void 0:a.logo)&&void 0!==i?i:(0,j.jsx)(tX.UnknownChain,{})},`${null==a?void 0:a.id}-${null==a?void 0:a.name}-${e}`):(0,j.jsx)(oi,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:oa},"loading")]})}):(0,j.jsx)("div",{style:{width:o,height:o}})},os=V(L.E.div)``,oc=V(L.E.button)`
  ...
  ${e=>e.disabled?A.iv`
        ...
        `}
`,ChevronDown=({...e})=>(0,j.jsx)("svg",{"aria-hidden":"true",width:"11",height:"6",viewBox:"0 0 11 6",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,j.jsx)("path",{d:"M1.5 1L5.5 5L9.5 1",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),ChainSelector=()=>{let e=useContext(),[n,t]=(0,S.useState)(!1),{chain:o}=(0,c.m)(),{chains:i}=(0,l.o)(),r=useLocales({CHAIN:null==o?void 0:o.name}),a=isMobile()||(null==window?void 0:window.innerWidth)<en.mobileWidth;(0,S.useEffect)(()=>{e.open||t(!1)},[e.open]);let s=i.length<=1;return(0,j.jsx)(j.Fragment,{children:(0,j.jsx)(os,{children:(0,j.jsx)(ChainSelectDropdown,{offsetX:-12,open:!a&&n,onClose:()=>t(!1),children:(0,j.jsxs)(oc,{"aria-label":flattenChildren(r.switchNetworks).toString(),disabled:s,onClick:()=>{a?e.setRoute(of.SWITCHNETWORKS):t(!n)},children:[s?(0,j.jsx)(Tooltip,{message:r.chainNetwork,xOffset:-6,delay:.01,children:(0,j.jsx)(Chain,{id:null==o?void 0:o.id})}):(0,j.jsx)(Chain,{id:null==o?void 0:o.id}),!s&&(0,j.jsx)(ChevronDown,{style:{top:1,left:-3}})]})})})})},Profile=({closeModal:e})=>{var n,t,o;let i=useContext(),r=useThemeContext(),a=useLocales(),{reset:s}=(0,p.$)(),{disconnect:l}=(0,C.q)(),{address:d,isConnected:h,connector:u,chain:x}=(0,c.m)(),b=useEnsFallbackConfig(),{data:f}=(0,g.F)({chainId:1,address:d,config:b}),{data:v}=(0,m.K)({address:d}),[k,w]=(0,S.useState)(!1);(0,S.useEffect)(()=>{h||i.setOpen(!1)},[h]),(0,S.useEffect)(()=>{if(k)return e?e():i.setOpen(!1),()=>{l(),s()}},[k,l,s]);let y=["web95","rounded","minimal"].includes(null!==(t=null!==(n=r.theme)&&void 0!==n?n:i.theme)&&void 0!==t?t:"")?"....":void 0;return(0,j.jsxs)(el,{children:[(0,j.jsxs)(eu,{style:{paddingBottom:22,gap:6},children:[(0,j.jsx)(tD,{children:(0,j.jsxs)(tR,{children:[(0,j.jsx)(tH,{children:(0,j.jsx)(ChainSelector,{})}),(0,j.jsx)(Avatar,{address:d})]})}),(0,j.jsx)(ex,{children:(0,j.jsx)(CopyToClipboard,{string:d,children:null!=f?f:truncateEthAddress(d,y)})}),(null===(o=null==i?void 0:i.options)||void 0===o?void 0:o.hideBalance)?null:(0,j.jsx)(eg,{children:(0,j.jsx)(tZ,{children:(0,j.jsxs)(M.M,{exitBeforeEnter:!0,initial:!1,children:[v&&(0,j.jsxs)(tU,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:[nFormatter(Number(null==v?void 0:v.formatted))," ",null==v?void 0:v.symbol]},`chain-${null==x?void 0:x.id}`),!v&&(0,j.jsx)(tV,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:"\xa0"})]})})})]}),!isSafeConnector(null==u?void 0:u.id)&&(0,j.jsx)(Button,{onClick:()=>w(!0),icon:(0,j.jsx)(DisconnectIcon,{}),children:a.disconnect})]})},SwitchNetworks=()=>{let{reset:e}=(0,p.$)(),{disconnect:n}=(0,C.q)(),{connector:t,chain:o}=(0,c.m)(),i=useChainIsSupported(null==o?void 0:o.id),r=useLocales({});return(0,j.jsx)(el,{style:{width:278},children:(0,j.jsxs)(eu,{style:{padding:0,marginTop:-10},children:[!i&&(0,j.jsxs)(eg,{children:[r.warnings_chainUnsupported," ",r.warnings_chainUnsupportedResolve]}),(0,j.jsx)("div",{style:{padding:"6px 8px"},children:(0,j.jsx)(ChainSelectList,{variant:"secondary"})}),!i&&!isSafeConnector(null==t?void 0:t.id)&&(0,j.jsxs)("div",{style:{paddingTop:12},children:[(0,j.jsx)(OrDivider,{}),(0,j.jsx)(Button,{icon:(0,j.jsx)(DisconnectIcon,{}),variant:"secondary",onClick:()=>{n(),e()},children:r.disconnect})]})]})})},ol=A.F4`
  from{ transform: rotate(0deg); }
  to{   transform: rotate(360deg); }
`,od=A.F4`
...
`,ou=V(L.E.div)`
  ...
  &:before {
    ...
    background: var(--ck-body-background);
    transition: inherit;
    animation: ${ol} 10s linear infinite;
  }
  &:after {
    z-index: 2;
    content: '';
...
`,og=V(L.E.div)`
  ...
  &:after {
    ...
    margin-left: -60px;
    transition: inherit;
    animation: ${od} 10s linear infinite;
    background: linear-gradient(
      90deg,
      var(--border-color),
      var(--border-color) 50%,
  ...
  ${({$connected:e})=>e&&A.iv`
    ...
    `};
`,SIWEButton=({showSignOutButton:e,onSignIn:n,onSignOut:t})=>{let o=useIsMounted(),i=useLocales(),{setOpen:r}=useModal(),{isSignedIn:a,isReady:s,isLoading:l,isRejected:d,isSuccess:p,isError:h,signIn:u,signOut:x,error:g}=useSIWE({onSignIn:e=>null==n?void 0:n(e),onSignOut:()=>null==t?void 0:t()}),{address:b}=(0,c.m)();return o?e&&a?(0,j.jsx)(Button,{style:{margin:0},onClick:x,icon:(0,j.jsx)(DisconnectIcon,{}),children:i.signOut},"button"):b?(0,j.jsx)(Button,{style:{margin:0},arrow:!a&&!l&&!d,onClick:l||p?void 0:u,disabled:l,waiting:l,icon:d&&(0,j.jsx)(L.E.div,{initial:{rotate:-270},animate:{rotate:0},transition:{duration:1,ease:[.175,.885,.32,.98]},children:(0,j.jsx)(RetryIcon,{style:{opacity:.4}})}),children:p?i.signedIn:d?i.tryAgain:l?i.awaitingConfirmation:h?null!=g?g:"Unknown Error":i.signIn},"button"):(0,j.jsx)(Button,{style:{margin:0},onClick:()=>r(!0),arrow:!0,children:i.walletNotConnected},"button"):(0,j.jsx)(Button,{style:{margin:0},disabled:!0},"loading")},LazyImage=({src:e,alt:n,width:t,height:o})=>{let i=(0,S.useRef)(null),[r,a]=(0,S.useState)(!0);return(0,S.useEffect)(()=>{i.current&&i.current.complete&&0!==i.current.naturalHeight||a(!1)},[e]),(0,j.jsx)("div",{style:{width:t,height:o,background:"rgba(0,0,0,0.02)",boxShadow:"inset 0 0 0 1px rgba(0,0,0,0.02)"},children:(0,j.jsx)("img",{ref:i,src:e,alt:n,width:t,height:o,onLoad:()=>a(!0),style:{transition:"opacity 0.2s ease",opacity:r?1:0}})})},ob={duration:.2,ease:[.26,.08,.25,1]},oC={duration:.16,ease:[.26,.08,.25,1]},SignInWithEthereum=()=>{var e,n;let t=useContext(),{isSignedIn:o,reset:i}=useSIWE(),r=isMobile(),[a,s]=(0,S.useState)(o?"signedIn":"signedOut"),l=useLocales({}),d="signedIn"===a?{heading:l.signInWithEthereumScreen_signedIn_heading,h1:l.signInWithEthereumScreen_signedIn_h1,p:l.signInWithEthereumScreen_signedIn_p,button:l.signInWithEthereumScreen_signedIn_button}:{heading:l.signInWithEthereumScreen_signedOut_heading,h1:l.signInWithEthereumScreen_signedOut_h1,p:l.signInWithEthereumScreen_signedOut_p,button:l.signInWithEthereumScreen_signedOut_button};(0,S.useEffect)(()=>{o&&s("signedIn")},[]),(0,S.useEffect)(()=>{o||s("signedOut")},[o]);let{address:p}=(0,c.m)(),h=(()=>{let e={svg:null,default:null},n=document.getElementsByTagName("link");return Array.from(n).forEach(n=>{("icon"===n.getAttribute("rel")||"shortcut icon"===n.getAttribute("rel"))&&n.getAttribute("href")&&("image/svg+xml"===n.getAttribute("type")?e.svg=n.getAttribute("href"):e.default=n.getAttribute("href"))}),e})(),u=null!==(n=null!==(e=getAppIcon())&&void 0!==e?e:h.svg)&&void 0!==n?n:h.default;return(0,j.jsx)(el,{style:{width:278},children:(0,j.jsxs)(eu,{style:{padding:0,marginTop:-10},children:[(0,j.jsx)(op,{children:(0,j.jsx)(M.M,{exitBeforeEnter:!0,children:(0,j.jsx)(L.E.div,{initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:oC,children:(0,j.jsx)(eg,{style:{height:42},children:(0,j.jsx)(FitText,{children:d.h1})})},flattenChildren(d.h1).toString())})}),(0,j.jsxs)(og,{$connected:o,children:[(0,j.jsx)("div",{style:{position:"absolute",inset:0},children:(0,j.jsx)(ox,{width:"262",height:"134",viewBox:"0 0 262 134",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,j.jsx)(L.E.rect,{x:"0",y:"0",rx:"12",width:"262",height:"134",strokeDasharray:"3 3",animate:{strokeDashoffset:[0,-6]},transition:{duration:.4,ease:"linear",repeat:1/0}})})}),(0,j.jsx)(L.E.div,{initial:!r&&{opacity:0,x:50,scale:.8},animate:{opacity:1,x:0,scale:1},transition:ob,children:(0,j.jsx)(oh,{children:(0,j.jsx)(Avatar,{address:p,size:64})})},"avatarImage"),(0,j.jsx)(L.E.div,{initial:!r&&{scale:.6},animate:{scale:1},transition:{...ob},children:(0,j.jsx)(ou,{children:(0,j.jsx)(TickIcon,{})})},"tickIcon"),(0,j.jsx)(L.E.div,{initial:!r&&{opacity:0,x:-40,scale:.8},animate:{opacity:1,x:0,scale:1},transition:{...ob},children:(0,j.jsx)(oh,{children:u?(0,j.jsx)(LazyImage,{src:u,alt:"app"}):(0,j.jsx)(tX.UnknownChain,{})})},"appLogo")]},"status"),(0,j.jsx)(M.M,{exitBeforeEnter:!0,children:(0,j.jsx)(L.E.div,{style:{paddingBottom:r?24:12},initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:oC,children:(0,j.jsx)(eg,{style:{height:42,marginTop:-1,marginBottom:-3},children:(0,j.jsx)(FitText,{children:d.p})})},flattenChildren(d.p).toString())}),(0,j.jsx)(SIWEButton,{showSignOutButton:"signedIn"===a,onSignIn:()=>{setTimeout(()=>{t.setOpen(!1)},1e3)}})]})})},om={},ConnectModal$1=({mode:e="auto",theme:n="auto",customTheme:t=om,lang:o="en-US"})=>{var i;let r=useContext(),{isConnected:a,chain:s}=(0,c.m)(),l=useChainIsSupported(null==s?void 0:s.id),d=!((null===(i=r.options)||void 0===i?void 0:i.enforceSupportedChains)&&a&&!l),p=d&&r.route!==of.CONNECTORS&&r.route!==of.PROFILE,h=d&&r.route!==of.PROFILE,u={onboarding:(0,j.jsx)(Introduction,{}),about:(0,j.jsx)(About,{}),download:(0,j.jsx)(DownloadApp,{}),connectors:(0,j.jsx)(Wallets,{}),mobileConnectors:(0,j.jsx)(MobileConnectors,{}),connect:(0,j.jsx)(ConnectUsing,{}),profile:(0,j.jsx)(Profile,{}),switchNetworks:(0,j.jsx)(SwitchNetworks,{}),signInWithEthereum:(0,j.jsx)(SignInWithEthereum,{})};function hide(){r.setOpen(!1)}return(0,S.useEffect)(()=>{var e;a?(r.route!==of.PROFILE||r.route!==of.SIGNINWITHETHEREUM)&&(!r.signInWithEthereum||(null===(e=r.options)||void 0===e?void 0:e.disableSiweRedirect)?hide():r.setRoute(of.SIGNINWITHETHEREUM)):hide()},[a]),(0,S.useEffect)(()=>r.setMode(e),[e]),(0,S.useEffect)(()=>r.setTheme(n),[n]),(0,S.useEffect)(()=>r.setCustomTheme(t),[t]),(0,S.useEffect)(()=>r.setLang(o),[o]),(0,S.useEffect)(()=>{let e=getAppName();if(!e||!r.open)return;let n=document.createElement("meta");return n.setAttribute("property","og:title"),n.setAttribute("content",e),document.head.prepend(n),()=>{document.head.removeChild(n)}},[r.open]),(0,j.jsx)(ConnectKitThemeProvider,{theme:n,customTheme:t,mode:e,children:(0,j.jsx)(Modal,{open:r.open,pages:u,pageId:r.route,onClose:d?hide:void 0,onInfo:h?()=>r.setRoute(of.ABOUT):void 0,onBack:p?()=>{r.route===of.SIGNINWITHETHEREUM?r.setRoute(of.PROFILE):r.route===of.SWITCHNETWORKS?r.setRoute(of.PROFILE):r.route===of.DOWNLOAD?r.setRoute(of.CONNECT):r.setRoute(of.CONNECTORS)}:void 0})})},useConnectCallback=({onConnect:e,onDisconnect:n})=>{(0,f.E)({onConnect:({address:n,connector:t,isReconnected:o})=>{o||null==e||e({address:n,connectorId:null==t?void 0:t.id})},onDisconnect:()=>null==n?void 0:n()})},of={ONBOARDING:"onboarding",ABOUT:"about",CONNECTORS:"connectors",MOBILECONNECTORS:"mobileConnectors",CONNECT:"connect",DOWNLOAD:"download",PROFILE:"profile",SWITCHNETWORKS:"switchNetworks",SIGNINWITHETHEREUM:"signInWithEthereum"},ov=(0,S.createContext)(null),ConnectKitProvider=({children:e,theme:n="auto",mode:t="auto",customTheme:o,options:i,onConnect:r,onDisconnect:a,debugMode:s=!1})=>{var l,d,p,h;if(!S.useContext(v.V))throw Error("ConnectKitProvider must be within a WagmiProvider");if(S.useContext(ov))throw Error("Multiple, nested usages of ConnectKitProvider detected. Please use only one.");useConnectCallback({onConnect:r,onDisconnect:a});let u=useChains(),x=useConnector("injected"),g={language:"en-US",hideBalance:!1,hideTooltips:!1,hideQuestionMarkCTA:!1,hideNoWalletCTA:!1,walletConnectCTA:"link",hideRecentBadge:!1,avoidLayoutShift:!0,embedGoogleFonts:!1,truncateLongENSAddress:!0,walletConnectName:void 0,reducedMotion:!1,disclaimer:null,bufferPolyfill:!0,customAvatar:void 0,initialChainId:null===(l=null==u?void 0:u[0])||void 0===l?void 0:l.id,enforceSupportedChains:!1,ethereumOnboardingUrl:void 0,walletOnboardingUrl:void 0,disableSiweRedirect:!1},b=Object.assign({},g,i);"undefined"!=typeof window&&b.bufferPolyfill&&(window.Buffer=null!==(d=window.Buffer)&&void 0!==d?d:N.Buffer);let[C,m]=(0,S.useState)(n),[f,k]=(0,S.useState)(t),[w,y]=(0,S.useState)(null!=o?o:{}),[E,L]=(0,S.useState)("en-US"),[M,I]=(0,S.useState)(!1),[_,F]=(0,S.useState)({id:""}),[O,W]=(0,S.useState)(of.CONNECTORS),[T,z]=(0,S.useState)(""),[B,D]=(0,S.useState)(0);b.embedGoogleFonts&&function(e){var n,t;let o=null!==(n=({web95:"Lato",retro:"Nunito",midnight:"Inter",minimal:"Inter",rounded:"Nunito"})[e])&&void 0!==n?n:null;t=null!=o?o:"",(0,S.useEffect)(()=>{if(!t)return;t=t.replace(/ /g,"+");let e=document.createElement("link");e.href="https://fonts.googleapis.com",e.rel="preconnect";let n=document.createElement("link");n.href="https://fonts.gstatic.com",n.rel="preconnect",n.crossOrigin="true";let o=document.createElement("link");return o.href=`https://fonts.googleapis.com/css2?family=${t}:wght@400;500;600&display=swap`,o.rel="stylesheet",document.head.appendChild(e),document.head.appendChild(n),document.head.appendChild(o),()=>{document.head.removeChild(e),document.head.removeChild(n),document.head.removeChild(o)}},[t])}(n),(0,S.useEffect)(()=>m(n),[n]),(0,S.useEffect)(()=>L(b.language||"en-US"),[b.language]),(0,S.useEffect)(()=>z(null),[O,M]);let{chain:R,isConnected:H}=(0,c.m)(),Z=useChainIsSupported(null==R?void 0:R.id);(0,S.useEffect)(()=>{H&&b.enforceSupportedChains&&!Z&&(I(!0),W(of.SWITCHNETWORKS))},[H,Z,R,O,M]),(0,S.useEffect)(()=>{isFamily()&&(null==x||x.connect())},[x]);let U=s?console.log:()=>{},V={theme:C,setTheme:m,mode:f,setMode:k,customTheme:o,setCustomTheme:y,lang:E,setLang:L,open:M,setOpen:I,route:O,setRoute:W,connector:_,setConnector:F,signInWithEthereum:null!==(h=null===(p=S.useContext(ez))||void 0===p?void 0:p.enabled)&&void 0!==h&&h,onConnect:r,options:b,errorMessage:T,debugMode:s,log:U,displayError:(e,n)=>{z(e),console.log("---------CONNECTKIT DEBUG---------"),console.log(e),n&&console.table(n),console.log("---------/CONNECTKIT DEBUG---------")},resize:B,triggerResize:()=>D(e=>e+1)};return(0,S.createElement)(ov.Provider,{value:V},(0,j.jsx)(j.Fragment,{children:(0,j.jsx)(Web3ContextProvider,{enabled:M,children:(0,j.jsxs)(A.f6,{theme:G,children:[e,(0,j.jsx)(ConnectModal$1,{lang:E,theme:C,mode:t,customTheme:w})]})})}))},useContext=()=>{let e=S.useContext(ov);if(!e)throw Error("ConnectKit Hook must be inside a Provider.");return e},ok={disconnected:[of.CONNECTORS,of.ABOUT,of.ONBOARDING,of.MOBILECONNECTORS,of.ONBOARDING],connected:[of.PROFILE,of.SWITCHNETWORKS,of.SIGNINWITHETHEREUM]},ow=[...ok.connected,...ok.disconnected],useModal=({onConnect:e,onDisconnect:n}={})=>{let t=useContext();useConnectCallback({onConnect:e,onDisconnect:n});let{isConnected:o}=(0,c.m)(),{signIn:i}=useSIWE(),close=()=>{t.setOpen(!1)},open=()=>{t.setOpen(!0)},gotoAndOpen=e=>{let n=e;ow.includes(e)?o?ok.connected.includes(e)||(n=of.PROFILE,t.log(`Route ${e} is not a valid route when connected, navigating to ${n} instead.`)):ok.disconnected.includes(e)||(n=of.CONNECTORS,t.log(`Route ${e} is not a valid route when disconnected, navigating to ${n} instead.`)):(n=o?of.PROFILE:of.CONNECTORS,t.log(`Route ${e} is not a valid route, navigating to ${n} instead.`)),t.setRoute(n),open()};return{open:t.open,setOpen:e=>{e?gotoAndOpen(o?of.PROFILE:of.CONNECTORS):close()},openAbout:()=>gotoAndOpen(of.ABOUT),openOnboarding:()=>gotoAndOpen(of.ONBOARDING),openProfile:()=>gotoAndOpen(of.PROFILE),openSwitchNetworks:()=>gotoAndOpen(of.SWITCHNETWORKS),openSIWE:e=>{gotoAndOpen(of.SIGNINWITHETHEREUM),e&&i()}}},oy=V(L.E.div)`
  top: 0;
  bottom: 0;
  left: 0;
  display: inline-flex;
...
`,ThemedButton=({children:e,variant:n="primary",autoSize:t=!0,duration:o=.3,style:i})=>{let[r,a]=(0,W.Z)();return(0,j.jsx)(oE,{className:n,initial:!1,animate:t?{width:a.width>10?a.width:"auto"}:void 0,transition:{duration:o,ease:[.25,1,.5,1],delay:.01},style:i,children:(0,j.jsx)("div",{ref:r,style:{whiteSpace:"nowrap",width:"fit-content",position:"relative",padding:"0 12px"},children:e})})},oL=V(L.E.div)`
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 8px;
...
`,oI=V.div`
  ...
  span {
    ...
    border-radius: 4px;
    background: currentColor;
    animation: ${oM} 1000ms ease infinite both;
  }
`,Balance=({hideIcon:e,hideSymbol:n})=>{let t=useIsMounted(),[o,i]=(0,S.useState)(!0),{address:r,chain:a}=(0,c.m)();useChains();let s=useChainIsSupported(null==a?void 0:a.id),l=(0,F.NL)(),{data:d}=(0,k.O)({watch:!0}),{data:p,queryKey:h}=(0,m.K)({address:r,chainId:null==a?void 0:a.id});(0,S.useEffect)(()=>{(null==d||d)&&l.invalidateQueries({queryKey:h})},[d,h]);let u=tJ.find(e=>e.id===(null==a?void 0:a.id)),x=`${t&&(null==p?void 0:p.formatted)!==void 0?`balance-${null==u?void 0:u.id}-${null==p?void 0:p.formatted}`:"balance-loading"}`;return(0,S.useEffect)(()=>{i(!1)},[]),(0,j.jsx)("div",{style:{position:"relative"},children:(0,j.jsx)(M.M,{initial:!1,children:(0,j.jsx)(L.E.div,{initial:(null==p?void 0:p.formatted)!==void 0&&o?{opacity:1}:{opacity:0,position:"absolute",top:0,left:0,bottom:0},animate:{opacity:1,position:"relative"},exit:{opacity:0,position:"absolute",top:0,left:0,bottom:0},transition:{duration:.4,ease:[.25,1,.5,1],delay:.4},children:r&&t&&(null==p?void 0:p.formatted)!==void 0?s?(0,j.jsxs)(oL,{children:[!e&&(0,j.jsx)(Chain,{id:null==a?void 0:a.id}),(0,j.jsx)("span",{style:{minWidth:32},children:nFormatter(Number(null==p?void 0:p.formatted))}),!n&&` ${null==p?void 0:p.symbol}`]}):(0,j.jsxs)(oL,{children:[!e&&(0,j.jsx)(Chain,{id:null==a?void 0:a.id}),(0,j.jsx)("span",{style:{minWidth:32},children:"???"})]}):(0,j.jsxs)(oL,{children:[!e&&(0,j.jsx)(Chain,{id:null==a?void 0:a.id}),(0,j.jsx)("span",{style:{minWidth:32},children:(0,j.jsxs)(oI,{children:[(0,j.jsx)("span",{style:{animationDelay:"0ms"}}),(0,j.jsx)("span",{style:{animationDelay:"50ms"}}),(0,j.jsx)("span",{style:{animationDelay:"100ms"}})]})})]})},x)})})},oA={initial:{zIndex:2,opacity:0,x:"-100%"},animate:{opacity:1,x:.1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,opacity:0,x:"-100%",pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},o_={initial:{zIndex:2,opacity:0,x:"100%"},animate:{x:.2,opacity:1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,x:"100%",opacity:0,pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},oF={initial:{opacity:0},animate:{opacity:1,transition:{duration:.3,ease:[.25,1,.5,1]}},exit:{position:"absolute",opacity:0,transition:{duration:.3,ease:[.25,1,.5,1]}}},ConnectButtonRenderer=({children:e})=>{let n=useIsMounted(),t=useContext(),{open:o,setOpen:i}=useModal(),{address:r,isConnected:a,chain:s}=(0,c.m)(),l=useChainIsSupported(null==s?void 0:s.id),d=useEnsFallbackConfig(),{data:p}=(0,g.F)({chainId:1,address:r,config:d});return e&&n?(0,j.jsx)(j.Fragment,{children:e({show:function(){i(!0),t.setRoute(a?of.PROFILE:of.CONNECTORS)},hide:function(){i(!1)},chain:s,unsupported:!l,isConnected:!!r,isConnecting:o,address:r,truncatedAddress:r?truncateEthAddress(r):void 0,ensName:null==p?void 0:p.toString()})}):null};function ConnectKitButtonInner({label:e,showAvatar:n,separator:t}){var o;let i=useLocales({}),r=useContext(),{isSignedIn:a}=useSIWE(),{address:s,chain:l}=(0,c.m)(),d=useChainIsSupported(null==l?void 0:l.id),p=useEnsFallbackConfig(),{data:h}=(0,g.F)({chainId:1,address:s,config:p}),u=i.connectWallet;return(0,j.jsx)(M.M,{initial:!1,children:s?(0,j.jsxs)(oy,{initial:"initial",animate:"animate",exit:"exit",variants:o_,style:{height:40},children:[n&&(0,j.jsxs)(oj,{children:[(0,j.jsxs)(M.M,{initial:!1,children:[a&&(0,j.jsx)(L.E.div,{style:{zIndex:2,position:"absolute",bottom:0,right:0},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,j.jsx)(AuthIcon,{})}),!d&&(0,j.jsx)(oS,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,j.jsx)("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,j.jsx)("path",{d:"M1.68831 13.5H12.0764C13.1026 13.5 13.7647 12.7197 13.7647 11.763C13.7647 11.4781 13.6985 11.1863 13.5462 10.9149L8.34225 1.37526C8.02445 0.791754 7.45505 0.5 6.88566 0.5C6.31627 0.5 5.73364 0.791754 5.42246 1.37526L0.225108 10.9217C0.0728291 11.1863 0 11.4781 0 11.763C0 12.7197 0.662083 13.5 1.68831 13.5ZM6.88566 8.8048C6.49503 8.8048 6.27655 8.5809 6.26331 8.1738L6.16399 5.0595C6.15075 4.64562 6.44869 4.34708 6.87904 4.34708C7.30278 4.34708 7.61396 4.6524 7.60071 5.06628L7.5014 8.16701C7.48154 8.5809 7.26305 8.8048 6.88566 8.8048ZM6.88566 11.3492C6.44207 11.3492 6.07792 11.0303 6.07792 10.5757C6.07792 10.1211 6.44207 9.80219 6.88566 9.80219C7.32926 9.80219 7.69341 10.1143 7.69341 10.5757C7.69341 11.0371 7.32264 11.3492 6.88566 11.3492Z",fill:"currentColor"})})})]}),(0,j.jsx)(Avatar,{size:24,address:s})]}),(0,j.jsx)("div",{style:{position:"relative",paddingRight:n?1:0},children:(0,j.jsx)(M.M,{initial:!1,children:h?(0,j.jsx)(oy,{initial:"initial",animate:"animate",exit:"exit",variants:oF,style:{position:h?"relative":"absolute"},children:(null===(o=r.options)||void 0===o?void 0:o.truncateLongENSAddress)?truncateENSAddress(h,20):h},"ckEnsName"):(0,j.jsxs)(oy,{initial:"initial",animate:"animate",exit:"exit",variants:oF,style:{position:h?"absolute":"relative"},children:[truncateEthAddress(s,t)," "]},"ckTruncatedAddress")})})]},"connectedText"):(0,j.jsx)(oy,{initial:"initial",animate:"animate",exit:"exit",variants:oA,style:{height:40},children:e||u},"connectWalletText")})}function ConnectKitButton({label:e,showBalance:n=!1,showAvatar:t=!0,theme:o,mode:i,customTheme:r,onClick:a}){var s;let l=useIsMounted(),d=useContext(),{isConnected:p,address:h,chain:u}=(0,c.m)(),x=useChainIsSupported(null==u?void 0:u.id);function show(){d.setOpen(!0),d.setRoute(p?of.PROFILE:of.CONNECTORS)}let g=["web95","rounded","minimal"].includes(null!==(s=null!=o?o:d.theme)&&void 0!==s?s:"")?"....":void 0;if(!l)return null;let b=n&&x;return(0,j.jsx)(ee,{$useTheme:null!=o?o:d.theme,$useMode:null!=i?i:d.mode,$customTheme:null!=r?r:d.customTheme,children:(0,j.jsxs)(oN,{onClick:()=>{a?a(show):show()},children:[b&&(0,j.jsx)(M.M,{initial:!1,children:h&&b&&(0,j.jsx)(L.E.div,{initial:{opacity:0,x:"100%",width:0,marginRight:0},animate:{opacity:1,x:0,width:"auto",marginRight:-24,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{opacity:0,x:"100%",width:0,marginRight:0,transition:{duration:.4,ease:[.25,1,.5,1]}},children:(0,j.jsx)(ThemedButton,{variant:"secondary",theme:null!=o?o:d.theme,mode:null!=i?i:d.mode,customTheme:null!=r?r:d.customTheme,style:{overflow:"hidden"},children:(0,j.jsx)(L.E.div,{style:{paddingRight:24},children:(0,j.jsx)(Balance,{hideSymbol:!0})})})},"balance")}),(0,j.jsx)(ThemedButton,{theme:null!=o?o:d.theme,mode:null!=i?i:d.mode,customTheme:null!=r?r:d.customTheme,style:b&&n&&h&&("retro"===o||"retro"===d.theme)?{boxShadow:"var(--ck-connectbutton-balance-connectbutton-box-shadow)",borderRadius:"var(--ck-connectbutton-balance-connectbutton-border-radius)",overflow:"hidden"}:{overflow:"hidden"},children:(0,j.jsx)(ConnectKitButtonInner,{separator:g,showAvatar:t,label:e})})]})})}ConnectButtonRenderer.displayName="ConnectKitButton.Custom",ConnectKitButton.Custom=ConnectButtonRenderer;let oO=A.F4`
  0%{ transform:none; }
...
`;V.div`
  ...
  opacity: 0;
  &.play {
    animation: ${oW} 1300ms 200ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,V.div`
  z-index: 1;
  position: absolute;
  inset: 0;
  &.shake {
    animation: ${oO} 300ms 100ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,V.div`
  z-index: 1;
  position: absolute;
